...
<link crossorigin="anonymous" media="all" rel="stylesheet" href="https://github.githubassets.com/assets/notifications-subscriptions-menu.1bcff9205c241e99cff2.module.css" />
  ...
  <title>portfolio_2025/assets/js/rpg/GameEnv.js at main · nighthawkcoders/portfolio_2025 · GitHub</title>
  ...
  <meta name="request-id" content="84A4:2BB3EB:1476E2F:14B2897:66F32234" data-pjax-transient="true"/><meta name="html-safe-nonce" content="90a9bdc6bdd092cab20f5532463ba941e56e77b5e7c03cc56598956e4d9ebc23" data-pjax-transient="true"/><meta name="visitor-payload" content="eyJyZWZlcnJlciI6IiIsInJlcXVlc3RfaWQiOiI4NEE0OjJCQjNFQjoxNDc2RTJGOjE0QjI4OTc6NjZGMzIyMzQiLCJ2aXNpdG9yX2lkIjoiNzgxNTE4OTM0MDM5OTgwNDk4MCIsInJlZ2lvbl9lZGdlIjoic2VhIiwicmVnaW9uX3JlbmRlciI6InNlYSJ9" data-pjax-transient="true"/><meta name="visitor-hmac" content="dacc048319374b1209cee63b8fc901f8a2b78a675e1be80a9bd0f98f0c650478" data-pjax-transient="true"/>
  ...
  <div class="d-flex flex-column flex-lg-row flex-items-center px-3 px-md-4 px-lg-5 height-full position-relative z-1">
    ...
    <path d="M12.5.75C6.146.75 1 5.896 1 12.25c0 5.089 3.292 9.387 7.863 10.91.575.101.79-.244.79-.546 0-.273-.014-1.178-.014-2.142-2.889.532-3.636-.704-3.866-1.35-.13-.331-.69-1.352-1.18-1.625-.402-.216-.977-.748-.014-.762.906-.014 1.553.834 1.769 1.179 1.035 1.74 2.688 1.25 3.349.948.1-.747.402-1.25.733-1.538-2.559-.287-5.232-1.279-5.232-5.678 0-1.25.445-2.285 1.178-3.09-.115-.288-.517-1.467.115-3.048 0 0 .963-.302 3.163 1.179.92-.259 1.897-.388 2.875-.388.977 0 1.955.13 2.875.388 2.2-1.495 3.162-1.179 3.162-1.179.633 1.581.23 2.76.115 3.048.733.805 1.179 1.825 1.179 3.09 0 4.413-2.688 5.39-5.247 5.678.417.36.776 1.05.776 2.128 0 1.538-.014 2.774-.014 3.162 0 .302.216.662.79.547C20.709 21.637 24 17.324 24 12.25 24 5.896 18.854.75 12.5.75Z"></path>
      ...
      <div class="flex-1 flex-order-2 text-right">
          <a
            href="/login?return_to=https%3A%2F%2Fgithub.com%2Fnighthawkcoders%2Fportfolio_2025%2Fblob%2Fmain%2Fassets%2Fjs%2Frpg%2FGameEnv.js"
            class="HeaderMenu-link HeaderMenu-button d-inline-flex d-lg-none flex-order-1 f5 no-underline border color-border-default rounded-2 px-2 py-1 color-fg-inherit js-prevent-focus-on-mobile-nav"
            data-hydro-click="{&quot;event_type&quot;:&quot;authentication.click&quot;,&quot;payload&quot;:{&quot;location_in_page&quot;:&quot;site header menu&quot;,&quot;repository_id&quot;:null,&quot;auth_type&quot;:&quot;SIGN_UP&quot;,&quot;originating_url&quot;:&quot;https://github.com/nighthawkcoders/portfolio_2025/blob/main/assets/js/rpg/GameEnv.js&quot;,&quot;user_id&quot;:null}}" data-hydro-click-hmac="00098491d691b08debe621db33483f2a00fc9aa86348ba8245d3407800e8d9ab"
...
<qbsearch-input class="search-input" data-scope="repo:nighthawkcoders/portfolio_2025" data-custom-scopes-path="/search/custom_scopes" data-delete-custom-scopes-csrf="MEPRKlKKvYzCqMwXYQyiSJ3HeTuCnCrwYTNlSdU0pKdKS38MnA958GQ53U1Zijjd-ntqkGkx8LX3gEHTyl7BPQ" data-max-custom-scopes="10" data-header-redesign-enabled="false" data-initial-value="" data-blackbird-suggestions-path="/search/suggestions" data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations" data-current-repository="nighthawkcoders/portfolio_2025" data-current-org="nighthawkcoders" data-current-owner="" data-logged-in="false" data-copilot-chat-enabled="false" data-nl-search-enabled="false" data-retain-scroll-position="true">
  <div
    ...
    <path d="M10.68 11.74a6 6 0 0 1-7.922-8.982 6 6 0 0 1 8.982 7.922l3.04 3.04a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215ZM11.5 7a4.499 4.499 0 1 0-8.997 0A4.499 4.499 0 0 0 11.5 7Z"></path>
        ...
        <div data-target="query-builder.styledInputContainer" class="QueryBuilder-StyledInputContainer">
          ...
          <div class="QueryBuilder-InputWrapper">
            ...
            <input id="query-builder-test" name="query-builder-test" value="" autocomplete="off" type="text" role="combobox" spellcheck="false" aria-expanded="false" aria-describedby="validation-414d0cb0-f2d3-47fa-b221-b3e8c5930c1f" data-target="query-builder.input" data-action="
...
<template id="device-desktop-icon">
  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-device-desktop">
    <path d="M14.25 1c.966 0 1.75.784 1.75 1.75v7.5A1.75 1.75 0 0 1 14.25 12h-3.727c.099 1.041.52 1.872 1.292 2.757A.752.752 0 0 1 11.25 16h-6.5a.75.75 0 0 1-.565-1.243c.772-.885 1.192-1.716 1.292-2.757H1.75A1.75 1.75 0 0 1 0 10.25v-7.5C0 1.784.784 1 1.75 1ZM1.75 2.5a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h12.5a.25.25 0 0 0 .25-.25v-7.5a.25.25 0 0 0-.25-.25ZM9.018 12H6.982a5.72 5.72 0 0 1-.765 2.5h3.566a5.72 5.72 0 0 1-.765-2.5Z"></path>
      ...
      <div class="FormControl-inlineValidation" id="validation-414d0cb0-f2d3-47fa-b221-b3e8c5930c1f" hidden="hidden">
  ...
  <div class="Overlay-headerContentWrap">
    ...
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <scrollable-region data-labelled-by="feedback-dialog-title">
        <div data-view-component="true" class="Overlay-body">        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="code-search-feedback-form" data-turbo="false" action="/search/feedback" accept-charset="UTF-8" method="post"><input type="hidden" data-csrf="true" name="authenticity_token" value="VKKcyn/3UYvSe0shFv8zevA1EQ33zPvafJewLtc6Rfy+Pm1k5DWuKYOzZp+job48AeEG1BMGFlvPXhxMF/r3Rw==" />
  ...
  <div class="Overlay-headerContentWrap">
    ...
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <scrollable-region data-labelled-by="custom-scopes-dialog-title">
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="custom-scopes-dialog-form" data-turbo="false" action="/search/custom_scopes" accept-charset="UTF-8" method="post"><input type="hidden" data-csrf="true" name="authenticity_token" value="2h0NpTkSaGArW1F0BZJh3bIo6TXIC3cOEbUziuC/juUTcRvgF4SWaLUB8CAq7dV17gc4tVpY4UH9beWoKvTZkA==" />
          ...
          <div class="form-group">
            ...
            <auto-check src="/search/custom_scopes/check_name" required>
              <input
                ...
                required
                maxlength="50">
              <input type="hidden" data-csrf="true" value="DRuuDM24WLfBqjzzmKf7ac+YCW/qEuVjEu4ba0aeBXqVH6qnC8XdULEi0O3H/NyDeROprgjMdiZ/7rcYiBgfXQ==" />
            </auto-check>
          </div>
    ...
    <button id="icon-button-b31c8ab4-443f-493e-8366-e9934b15c3b1" aria-labelledby="tooltip-93d10755-8044-4de3-9f5a-853e56db3f9b" type="button" data-view-component="true" class="Button Button--iconOnly Button--invisible Button--medium flash-close js-flash-close">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-x Button-visual">
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
</svg>
</button><tool-tip id="tooltip-93d10755-8044-4de3-9f5a-853e56db3f9b" for="icon-button-b31c8ab4-443f-493e-8366-e9934b15c3b1" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Dismiss alert</tool-tip>
...
<div class="flash flash-full   {{ className }}">
  ...
  <focus-group direction="vertical" mnemonics retain>
    <button id="action-menu-2662923e-976e-41b2-a28b-9ac7b374d1be-button" popovertarget="action-menu-2662923e-976e-41b2-a28b-9ac7b374d1be-overlay" aria-controls="action-menu-2662923e-976e-41b2-a28b-9ac7b374d1be-list" aria-haspopup="true" aria-labelledby="tooltip-b9270cf9-427b-4275-be90-92cd761b5454" type="button" data-view-component="true" class="Button Button--iconOnly Button--secondary Button--medium UnderlineNav-item">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-kebab-horizontal Button-visual">
    <path d="M8 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3ZM1.5 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Zm13 0a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path>
</svg>
</button><tool-tip id="tooltip-b9270cf9-427b-4275-be90-92cd761b5454" for="action-menu-2662923e-976e-41b2-a28b-9ac7b374d1be-button" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Additional navigation options</tool-tip>


<anchored-position id="action-menu-2662923e-976e-41b2-a28b-9ac7b374d1be-overlay" anchor="action-menu-2662923e-976e-41b2-a28b-9ac7b374d1be-button" align="start" side="outside-bottom" anchor-offset="normal" popover="auto" data-view-component="true">
  <div data-view-component="true" class="Overlay Overlay--size-auto">
    
      <div data-view-component="true" class="Overlay-body Overlay-body--paddingNone">          <action-list>
  <div data-view-component="true">
    <ul aria-labelledby="action-menu-2662923e-976e-41b2-a28b-9ac7b374d1be-button" id="action-menu-2662923e-976e-41b2-a28b-9ac7b374d1be-list" role="menu" data-view-component="true" class="ActionListWrap--inset ActionListWrap">
        <li hidden="hidden" data-menu-item="i0code-tab" data-targets="action-list.items" role="none" data-view-component="true" class="ActionListItem">
    
    
    <a tabindex="-1" id="item-2905c0a6-dad0-46f4-9e53-9d5766497e29" href="/nighthawkcoders/portfolio_2025" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
    ...
    <a tabindex="-1" id="item-1f3be494-ab38-4815-b90c-178a56e66caf" href="/nighthawkcoders/portfolio_2025/issues" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-issue-opened">
    <path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path><path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-17484259-1549-4117-9493-d47fdbdab7bd" href="/nighthawkcoders/portfolio_2025/pulls" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
    ...
    <a tabindex="-1" id="item-6a5d35d6-c170-4411-860a-49a0972ba328" href="/nighthawkcoders/portfolio_2025/actions" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-play">
    <path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Zm4.879-2.773 4.264 2.559a.25.25 0 0 1 0 .428l-4.264 2.559A.25.25 0 0 1 6 10.559V5.442a.25.25 0 0 1 .379-.215Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-93d753b8-0035-450e-b888-52196d237b8b" href="/nighthawkcoders/portfolio_2025/projects" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
    ...
    <a tabindex="-1" id="item-48370ffb-23c5-49a3-b20c-a0a54cdeac8e" href="/nighthawkcoders/portfolio_2025/security" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
    ...
    <a tabindex="-1" id="item-24291220-c1cd-45cf-ad44-1c61e1bdc45e" href="/nighthawkcoders/portfolio_2025/pulse" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<react-app
  ...
  initial-path="/nighthawkcoders/portfolio_2025/blob/main/assets/js/rpg/GameEnv.js"
...
>
  ...
  <script type="application/json" data-target="react-app.embeddedData">{"payload":{"allShortcutsEnabled":false,"fileTree":{"assets/js/rpg":{"items":[{"name":"Background.js","path":"assets/js/rpg/Background.js","contentType":"file"},{"name":"GameControl.js","path":"assets/js/rpg/GameControl.js","contentType":"file"},{"name":"GameEnv.js","path":"assets/js/rpg/GameEnv.js","contentType":"file"},{"name":"Player.js","path":"assets/js/rpg/Player.js","contentType":"file"}],"totalCount":4},"assets/js":{"items":[{"name":"api","path":"assets/js/api","contentType":"directory"},{"name":"javaUI","path":"assets/js/javaUI","contentType":"directory"},{"name":"logicGateGame","path":"assets/js/logicGateGame","contentType":"directory"},{"name":"platformer3x","path":"assets/js/platformer3x","contentType":"directory"},{"name":"rpg","path":"assets/js/rpg","contentType":"directory"},{"name":"vendor","path":"assets/js/vendor","contentType":"directory"},{"name":"chatbot.js","path":"assets/js/chatbot.js","contentType":"file"},{"name":"layer.js","path":"assets/js/layer.js","contentType":"file"},{"name":"player.js","path":"assets/js/player.js","contentType":"file"},{"name":"search-data.json","path":"assets/js/search-data.json","contentType":"file"},{"name":"search.js","path":"assets/js/search.js","contentType":"file"},{"name":"three.r119.min.js","path":"assets/js/three.r119.min.js","contentType":"file"},{"name":"vanta.birds.min.js","path":"assets/js/vanta.birds.min.js","contentType":"file"},{"name":"vanta.halo.min.js","path":"assets/js/vanta.halo.min.js","contentType":"file"},{"name":"vanta.net.min.js","path":"assets/js/vanta.net.min.js","contentType":"file"},{"name":"vanta.rings.min.js","path":"assets/js/vanta.rings.min.js","contentType":"file"}],"totalCount":16},"assets":{"items":[{"name":"audio","path":"assets/audio","contentType":"directory"},{"name":"badges","path":"assets/badges","contentType":"directory"},{"name":"icons","path":"assets/icons","contentType":"directory"},{"name":"js","path":"assets/js","contentType":"directory"}],"totalCount":4},"":{"items":[{"name":".github","path":".github","contentType":"directory"},{"name":".vscode","path":".vscode","contentType":"directory"},{"name":"IJava","path":"IJava","contentType":"submodule","submoduleUrl":null,"submoduleDisplayName":"IJava"},{"name":"_data","path":"_data","contentType":"directory"},{"name":"_includes","path":"_includes","contentType":"directory"},{"name":"_layouts","path":"_layouts","contentType":"directory"},{"name":"_notebooks","path":"_notebooks","contentType":"directory"},{"name":"_posts","path":"_posts","contentType":"directory"},{"name":"_sass","path":"_sass","contentType":"directory"},{"name":"assets","path":"assets","contentType":"directory"},{"name":"design","path":"design","contentType":"directory"},{"name":"images","path":"images","contentType":"directory"},{"name":"kasm_design","path":"kasm_design","contentType":"directory"},{"name":"navigation","path":"navigation","contentType":"directory"},{"name":"node_backend","path":"node_backend","contentType":"directory"},{"name":"scripts","path":"scripts","contentType":"directory"},{"name":".gitignore","path":".gitignore","contentType":"file"},{"name":"404.html","path":"404.html","contentType":"file"},{"name":"Gemfile","path":"Gemfile","contentType":"file"},{"name":"LICENSE","path":"LICENSE","contentType":"file"},{"name":"Makefile","path":"Makefile","contentType":"file"},{"name":"README.md","path":"README.md","contentType":"file"},{"name":"README4YML.md","path":"README4YML.md","contentType":"file"},{"name":"_config.yml","path":"_config.yml","contentType":"file"},{"name":"index.md","path":"index.md","contentType":"file"},{"name":"requirements.txt","path":"requirements.txt","contentType":"file"}],"totalCount":26}},"fileTreeProcessingTime":10.397209,"foldersToFetch":[],"repo":{"id":812275373,"defaultBranch":"main","name":"portfolio_2025","ownerLogin":"nighthawkcoders","currentUserCanPush":false,"isFork":false,"isEmpty":false,"createdAt":"2024-06-08T12:36:26.000Z","ownerAvatar":"https://avatars.githubusercontent.com/u/66652504?v=4","public":true,"private":false,"isOrgOwned":true},"codeLineWrapEnabled":false,"symbolsExpanded":false,"treeExpanded":true,"refInfo":{"name":"main","listCacheKey":"v0:1717850189.0","canEdit":false,"refType":"branch","currentOid":"e49e6dbf30737f4d604ee374693c55287fb441e4"},"path":"assets/js/rpg/GameEnv.js","currentUser":null,"blob":{"rawLines":["/**"," * GameEnv is a static class that manages the game environment."," * "," * The focus of the file is the canvas management and the calculation of the game area dimensions. "," * All calculations are based on the window size, header, and footer."," * "," * This code uses a classic Java static class pattern, which is nice for managing centralized data."," * "," * The static class pattern ensures that there is only one instance of the game environment,"," * providing a single point of reference for all game objects. This approach helps maintain"," * consistency and simplifies the management of shared resources like the canvas and its dimensions."," * "," * @class GameEnv"," * @property {Object} canvas - The canvas element."," * @property {Object} ctx - The 2D rendering context of the canvas."," * @property {number} innerWidth - The inner width of the game area."," * @property {number} innerHeight - The inner height of the game area."," * @property {number} top - The top offset of the game area."," * @property {number} bottom - The bottom offset of the game area."," */","class GameEnv {","    static canvas;","    static ctx;","    static innerWidth;","    static innerHeight;","    static top;","    static bottom;","","    /**","     * Private constructor to prevent instantiation.","     * ","     * @constructor","     * @throws {Error} Throws an error if an attempt is made to instantiate the class.","     */","    constructor() {","        throw new Error('GameEnv is a static class and cannot be instantiated.');","    }","","    /**","     * Create the game environment by setting up the canvas and calculating dimensions.","     * ","     * This method sets the canvas element, calculates the top and bottom offsets,","     * and determines the inner width and height of the game area. It then sizes the canvas","     * to fit within the calculated dimensions.","     * ","     * @static","     */","    static create() {","        this.setCanvas();","        this.setTop();","        this.setBottom();","        this.innerWidth = window.innerWidth;","        this.innerHeight = window.innerHeight - this.top - this.bottom;","        this.size();","    }","","    /**","     * Sets the canvas element and its 2D rendering context.","     * ","     * @static","     */","    static setCanvas() {","        this.canvas = document.getElementById('gameCanvas');","        this.ctx = this.canvas.getContext('2d');","    }","","    /**","     * Sets the top offset based on the height of the header element.","     * ","     * @static","     */","    static setTop() {","        const header = document.querySelector('header');","        this.top = header ? header.offsetHeight : 0;","    }","","    /**","     * Sets the bottom offset based on the height of the footer element.","     * ","     * @static","     */","    static setBottom() {","        const footer = document.querySelector('footer');","        this.bottom = footer ? footer.offsetHeight : 0;","    }","","    /**","     * Sizes the canvas to fit within the calculated dimensions.","     * ","     * @static","     */","    static size() {","        this.canvas.width = this.innerWidth;","        this.canvas.height = this.innerHeight;","        this.canvas.style.width = `${this.innerWidth}px`;","        this.canvas.style.height = `${this.innerHeight}px`;","        this.canvas.style.position = 'absolute';","        this.canvas.style.left = '0px';","        this.canvas.style.top = `${this.top}px`;","    }","","    /**","     * Resizes the game environment by re-creating it.","     * ","     * @static","     */","    static resize() {","        this.create();","    }","","    /**","     * Clears the canvas.","     * ","     * This method clears the entire canvas, making it ready for the next frame.","     * ","     * @static","     */","    static clear() {","        this.ctx.clearRect(0, 0, this.innerWidth, this.innerHeight);","    }","}","","export default GameEnv;"],"stylingDirectives":[[{"s":0,"e":3,"c":"pl-c"}],[{"s":0,"e":63,"c":"pl-c"}],[{"s":0,"e":3,"c":"pl-c"}],[{"s":0,"e":99,"c":"pl-c"}],[{"s":0,"e":69,"c":"pl-c"}],[{"s":0,"e":3,"c":"pl-c"}],[{"s":0,"e":99,"c":"pl-c"}],[{"s":0,"e":3,"c":"pl-c"}],[{"s":0,"e":92,"c":"pl-c"}],[{"s":0,"e":91,"c":"pl-c"}],[{"s":0,"e":100,"c":"pl-c"}],[{"s":0,"e":3,"c":"pl-c"}],[{"s":0,"e":17,"c":"pl-c"}],[{"s":0,"e":50,"c":"pl-c"}],[{"s":0,"e":67,"c":"pl-c"}],[{"s":0,"e":68,"c":"pl-c"}],[{"s":0,"e":70,"c":"pl-c"}],[{"s":0,"e":60,"c":"pl-c"}],[{"s":0,"e":66,"c":"pl-c"}],[{"s":0,"e":3,"c":"pl-c"}],[{"s":0,"e":5,"c":"pl-k"},{"s":6,"e":13,"c":"pl-v"},{"s":14,"e":15,"c":"pl-kos"}],[{"s":4,"e":10,"c":"pl-k"},{"s":11,"e":17,"c":"pl-c1"},{"s":17,"e":18,"c":"pl-kos"}],[{"s":4,"e":10,"c":"pl-k"},{"s":11,"e":14,"c":"pl-c1"},{"s":14,"e":15,"c":"pl-kos"}],[{"s":4,"e":10,"c":"pl-k"},{"s":11,"e":21,"c":"pl-c1"},{"s":21,"e":22,"c":"pl-kos"}],[{"s":4,"e":10,"c":"pl-k"},{"s":11,"e":22,"c":"pl-c1"},{"s":22,"e":23,"c":"pl-kos"}],[{"s":4,"e":10,"c":"pl-k"},{"s":11,"e":14,"c":"pl-c1"},{"s":14,"e":15,"c":"pl-kos"}],[{"s":4,"e":10,"c":"pl-k"},{"s":11,"e":17,"c":"pl-c1"},{"s":17,"e":18,"c":"pl-kos"}],[],[{"s":4,"e":7,"c":"pl-c"}],[{"s":0,"e":52,"c":"pl-c"}],[{"s":0,"e":7,"c":"pl-c"}],[{"s":0,"e":19,"c":"pl-c"}],[{"s":0,"e":86,"c":"pl-c"}],[{"s":0,"e":7,"c":"pl-c"}],[{"s":4,"e":15,"c":"pl-en"},{"s":15,"e":16,"c":"pl-kos"},{"s":16,"e":17,"c":"pl-kos"},{"s":18,"e":19,"c":"pl-kos"}],[{"s":8,"e":13,"c":"pl-k"},{"s":14,"e":17,"c":"pl-k"},{"s":18,"e":23,"c":"pl-v"},{"s":23,"e":24,"c":"pl-kos"},{"s":24,"e":79,"c":"pl-s"},{"s":79,"e":80,"c":"pl-kos"},{"s":80,"e":81,"c":"pl-kos"}],[{"s":4,"e":5,"c":"pl-kos"}],[],[{"s":4,"e":7,"c":"pl-c"}],[{"s":0,"e":87,"c":"pl-c"}],[{"s":0,"e":7,"c":"pl-c"}],[{"s":0,"e":82,"c":"pl-c"}],[{"s":0,"e":91,"c":"pl-c"}],[{"s":0,"e":47,"c":"pl-c"}],[{"s":0,"e":7,"c":"pl-c"}],[{"s":0,"e":14,"c":"pl-c"}],[{"s":0,"e":7,"c":"pl-c"}],[{"s":4,"e":10,"c":"pl-k"},{"s":11,"e":17,"c":"pl-en"},{"s":17,"e":18,"c":"pl-kos"},{"s":18,"e":19,"c":"pl-kos"},{"s":20,"e":21,"c":"pl-kos"}],[{"s":8,"e":12,"c":"pl-smi"},{"s":12,"e":13,"c":"pl-kos"},{"s":13,"e":22,"c":"pl-en"},{"s":22,"e":23,"c":"pl-kos"},{"s":23,"e":24,"c":"pl-kos"},{"s":24,"e":25,"c":"pl-kos"}],[{"s":8,"e":12,"c":"pl-smi"},{"s":12,"e":13,"c":"pl-kos"},{"s":13,"e":19,"c":"pl-en"},{"s":19,"e":20,"c":"pl-kos"},{"s":20,"e":21,"c":"pl-kos"},{"s":21,"e":22,"c":"pl-kos"}],[{"s":8,"e":12,"c":"pl-smi"},{"s":12,"e":13,"c":"pl-kos"},{"s":13,"e":22,"c":"pl-en"},{"s":22,"e":23,"c":"pl-kos"},{"s":23,"e":24,"c":"pl-kos"},{"s":24,"e":25,"c":"pl-kos"}],[{"s":8,"e":12,"c":"pl-smi"},{"s":12,"e":13,"c":"pl-kos"},{"s":13,"e":23,"c":"pl-c1"},{"s":24,"e":25,"c":"pl-c1"},{"s":26,"e":32,"c":"pl-smi"},{"s":32,"e":33,"c":"pl-kos"},{"s":33,"e":43,"c":"pl-c1"},{"s":43,"e":44,"c":"pl-kos"}],[{"s":8,"e":12,"c":"pl-smi"},{"s":12,"e":13,"c":"pl-kos"},{"s":13,"e":24,"c":"pl-c1"},{"s":25,"e":26,"c":"pl-c1"},{"s":27,"e":33,"c":"pl-smi"},{"s":33,"e":34,"c":"pl-kos"},{"s":34,"e":45,"c":"pl-c1"},{"s":46,"e":47,"c":"pl-c1"},{"s":48,"e":52,"c":"pl-smi"},{"s":52,"e":53,"c":"pl-kos"},{"s":53,"e":56,"c":"pl-c1"},{"s":57,"e":58,"c":"pl-c1"},{"s":59,"e":63,"c":"pl-smi"},{"s":63,"e":64,"c":"pl-kos"},{"s":64,"e":70,"c":"pl-c1"},{"s":70,"e":71,"c":"pl-kos"}],[{"s":8,"e":12,"c":"pl-smi"},{"s":12,"e":13,"c":"pl-kos"},{"s":13,"e":17,"c":"pl-en"},{"s":17,"e":18,"c":"pl-kos"},{"s":18,"e":19,"c":"pl-kos"},{"s":19,"e":20,"c":"pl-kos"}],[{"s":4,"e":5,"c":"pl-kos"}],[],[{"s":4,"e":7,"c":"pl-c"}],[{"s":0,"e":60,"c":"pl-c"}],[{"s":0,"e":7,"c":"pl-c"}],[{"s":0,"e":14,"c":"pl-c"}],[{"s":0,"e":7,"c":"pl-c"}],[{"s":4,"e":10,"c":"pl-k"},{"s":11,"e":20,"c":"pl-en"},{"s":20,"e":21,"c":"pl-kos"},{"s":21,"e":22,"c":"pl-kos"},{"s":23,"e":24,"c":"pl-kos"}],[{"s":8,"e":12,"c":"pl-smi"},{"s":12,"e":13,"c":"pl-kos"},{"s":13,"e":19,"c":"pl-c1"},{"s":20,"e":21,"c":"pl-c1"},{"s":22,"e":30,"c":"pl-smi"},{"s":30,"e":31,"c":"pl-kos"},{"s":31,"e":45,"c":"pl-en"},{"s":45,"e":46,"c":"pl-kos"},{"s":46,"e":58,"c":"pl-s"},{"s":58,"e":59,"c":"pl-kos"},{"s":59,"e":60,"c":"pl-kos"}],[{"s":8,"e":12,"c":"pl-smi"},{"s":12,"e":13,"c":"pl-kos"},{"s":13,"e":16,"c":"pl-c1"},{"s":17,"e":18,"c":"pl-c1"},{"s":19,"e":23,"c":"pl-smi"},{"s":23,"e":24,"c":"pl-kos"},{"s":24,"e":30,"c":"pl-c1"},{"s":30,"e":31,"c":"pl-kos"},{"s":31,"e":41,"c":"pl-en"},{"s":41,"e":42,"c":"pl-kos"},{"s":42,"e":46,"c":"pl-s"},{"s":46,"e":47,"c":"pl-kos"},{"s":47,"e":48,"c":"pl-kos"}],[{"s":4,"e":5,"c":"pl-kos"}],[],[{"s":4,"e":7,"c":"pl-c"}],[{"s":0,"e":69,"c":"pl-c"}],[{"s":0,"e":7,"c":"pl-c"}],[{"s":0,"e":14,"c":"pl-c"}],[{"s":0,"e":7,"c":"pl-c"}],[{"s":4,"e":10,"c":"pl-k"},{"s":11,"e":17,"c":"pl-en"},{"s":17,"e":18,"c":"pl-kos"},{"s":18,"e":19,"c":"pl-kos"},{"s":20,"e":21,"c":"pl-kos"}],[{"s":8,"e":13,"c":"pl-k"},{"s":14,"e":20,"c":"pl-s1"},{"s":21,"e":22,"c":"pl-c1"},{"s":23,"e":31,"c":"pl-smi"},{"s":31,"e":32,"c":"pl-kos"},{"s":32,"e":45,"c":"pl-en"},{"s":45,"e":46,"c":"pl-kos"},{"s":46,"e":54,"c":"pl-s"},{"s":54,"e":55,"c":"pl-kos"},{"s":55,"e":56,"c":"pl-kos"}],[{"s":8,"e":12,"c":"pl-smi"},{"s":12,"e":13,"c":"pl-kos"},{"s":13,"e":16,"c":"pl-c1"},{"s":17,"e":18,"c":"pl-c1"},{"s":19,"e":25,"c":"pl-s1"},{"s":28,"e":34,"c":"pl-s1"},{"s":34,"e":35,"c":"pl-kos"},{"s":35,"e":47,"c":"pl-c1"},{"s":50,"e":51,"c":"pl-c1"},{"s":51,"e":52,"c":"pl-kos"}],[{"s":4,"e":5,"c":"pl-kos"}],[],[{"s":4,"e":7,"c":"pl-c"}],[{"s":0,"e":72,"c":"pl-c"}],[{"s":0,"e":7,"c":"pl-c"}],[{"s":0,"e":14,"c":"pl-c"}],[{"s":0,"e":7,"c":"pl-c"}],[{"s":4,"e":10,"c":"pl-k"},{"s":11,"e":20,"c":"pl-en"},{"s":20,"e":21,"c":"pl-kos"},{"s":21,"e":22,"c":"pl-kos"},{"s":23,"e":24,"c":"pl-kos"}],[{"s":8,"e":13,"c":"pl-k"},{"s":14,"e":20,"c":"pl-s1"},{"s":21,"e":22,"c":"pl-c1"},{"s":23,"e":31,"c":"pl-smi"},{"s":31,"e":32,"c":"pl-kos"},{"s":32,"e":45,"c":"pl-en"},{"s":45,"e":46,"c":"pl-kos"},{"s":46,"e":54,"c":"pl-s"},{"s":54,"e":55,"c":"pl-kos"},{"s":55,"e":56,"c":"pl-kos"}],[{"s":8,"e":12,"c":"pl-smi"},{"s":12,"e":13,"c":"pl-kos"},{"s":13,"e":19,"c":"pl-c1"},{"s":20,"e":21,"c":"pl-c1"},{"s":22,"e":28,"c":"pl-s1"},{"s":31,"e":37,"c":"pl-s1"},{"s":37,"e":38,"c":"pl-kos"},{"s":38,"e":50,"c":"pl-c1"},{"s":53,"e":54,"c":"pl-c1"},{"s":54,"e":55,"c":"pl-kos"}],[{"s":4,"e":5,"c":"pl-kos"}],[],[{"s":4,"e":7,"c":"pl-c"}],[{"s":0,"e":64,"c":"pl-c"}],[{"s":0,"e":7,"c":"pl-c"}],[{"s":0,"e":14,"c":"pl-c"}],[{"s":0,"e":7,"c":"pl-c"}],[{"s":4,"e":10,"c":"pl-k"},{"s":11,"e":15,"c":"pl-en"},{"s":15,"e":16,"c":"pl-kos"},{"s":16,"e":17,"c":"pl-kos"},{"s":18,"e":19,"c":"pl-kos"}],[{"s":8,"e":12,"c":"pl-smi"},{"s":12,"e":13,"c":"pl-kos"},{"s":13,"e":19,"c":"pl-c1"},{"s":19,"e":20,"c":"pl-kos"},{"s":20,"e":25,"c":"pl-c1"},{"s":26,"e":27,"c":"pl-c1"},{"s":28,"e":32,"c":"pl-smi"},{"s":32,"e":33,"c":"pl-kos"},{"s":33,"e":43,"c":"pl-c1"},{"s":43,"e":44,"c":"pl-kos"}],[{"s":8,"e":12,"c":"pl-smi"},{"s":12,"e":13,"c":"pl-kos"},{"s":13,"e":19,"c":"pl-c1"},{"s":19,"e":20,"c":"pl-kos"},{"s":20,"e":26,"c":"pl-c1"},{"s":27,"e":28,"c":"pl-c1"},{"s":29,"e":33,"c":"pl-smi"},{"s":33,"e":34,"c":"pl-kos"},{"s":34,"e":45,"c":"pl-c1"},{"s":45,"e":46,"c":"pl-kos"}],[{"s":8,"e":12,"c":"pl-smi"},{"s":12,"e":13,"c":"pl-kos"},{"s":13,"e":19,"c":"pl-c1"},{"s":19,"e":20,"c":"pl-kos"},{"s":20,"e":25,"c":"pl-c1"},{"s":25,"e":26,"c":"pl-kos"},{"s":26,"e":31,"c":"pl-c1"},{"s":32,"e":33,"c":"pl-c1"},{"s":34,"e":56,"c":"pl-s"},{"s":35,"e":53,"c":"pl-s1"},{"s":35,"e":37,"c":"pl-kos"},{"s":37,"e":41,"c":"pl-smi"},{"s":41,"e":42,"c":"pl-kos"},{"s":42,"e":52,"c":"pl-c1"},{"s":52,"e":53,"c":"pl-kos"},{"s":56,"e":57,"c":"pl-kos"}],[{"s":8,"e":12,"c":"pl-smi"},{"s":12,"e":13,"c":"pl-kos"},{"s":13,"e":19,"c":"pl-c1"},{"s":19,"e":20,"c":"pl-kos"},{"s":20,"e":25,"c":"pl-c1"},{"s":25,"e":26,"c":"pl-kos"},{"s":26,"e":32,"c":"pl-c1"},{"s":33,"e":34,"c":"pl-c1"},{"s":35,"e":58,"c":"pl-s"},{"s":36,"e":55,"c":"pl-s1"},{"s":36,"e":38,"c":"pl-kos"},{"s":38,"e":42,"c":"pl-smi"},{"s":42,"e":43,"c":"pl-kos"},{"s":43,"e":54,"c":"pl-c1"},{"s":54,"e":55,"c":"pl-kos"},{"s":58,"e":59,"c":"pl-kos"}],[{"s":8,"e":12,"c":"pl-smi"},{"s":12,"e":13,"c":"pl-kos"},{"s":13,"e":19,"c":"pl-c1"},{"s":19,"e":20,"c":"pl-kos"},{"s":20,"e":25,"c":"pl-c1"},{"s":25,"e":26,"c":"pl-kos"},{"s":26,"e":34,"c":"pl-c1"},{"s":35,"e":36,"c":"pl-c1"},{"s":37,"e":47,"c":"pl-s"},{"s":47,"e":48,"c":"pl-kos"}],[{"s":8,"e":12,"c":"pl-smi"},{"s":12,"e":13,"c":"pl-kos"},{"s":13,"e":19,"c":"pl-c1"},{"s":19,"e":20,"c":"pl-kos"},{"s":20,"e":25,"c":"pl-c1"},{"s":25,"e":26,"c":"pl-kos"},{"s":26,"e":30,"c":"pl-c1"},{"s":31,"e":32,"c":"pl-c1"},{"s":33,"e":38,"c":"pl-s"},{"s":38,"e":39,"c":"pl-kos"}],[{"s":8,"e":12,"c":"pl-smi"},{"s":12,"e":13,"c":"pl-kos"},{"s":13,"e":19,"c":"pl-c1"},{"s":19,"e":20,"c":"pl-kos"},{"s":20,"e":25,"c":"pl-c1"},{"s":25,"e":26,"c":"pl-kos"},{"s":26,"e":29,"c":"pl-c1"},{"s":30,"e":31,"c":"pl-c1"},{"s":32,"e":47,"c":"pl-s"},{"s":33,"e":44,"c":"pl-s1"},{"s":33,"e":35,"c":"pl-kos"},{"s":35,"e":39,"c":"pl-smi"},{"s":39,"e":40,"c":"pl-kos"},{"s":40,"e":43,"c":"pl-c1"},{"s":43,"e":44,"c":"pl-kos"},{"s":47,"e":48,"c":"pl-kos"}],[{"s":4,"e":5,"c":"pl-kos"}],[],[{"s":4,"e":7,"c":"pl-c"}],[{"s":0,"e":54,"c":"pl-c"}],[{"s":0,"e":7,"c":"pl-c"}],[{"s":0,"e":14,"c":"pl-c"}],[{"s":0,"e":7,"c":"pl-c"}],[{"s":4,"e":10,"c":"pl-k"},{"s":11,"e":17,"c":"pl-en"},{"s":17,"e":18,"c":"pl-kos"},{"s":18,"e":19,"c":"pl-kos"},{"s":20,"e":21,"c":"pl-kos"}],[{"s":8,"e":12,"c":"pl-smi"},{"s":12,"e":13,"c":"pl-kos"},{"s":13,"e":19,"c":"pl-en"},{"s":19,"e":20,"c":"pl-kos"},{"s":20,"e":21,"c":"pl-kos"},{"s":21,"e":22,"c":"pl-kos"}],[{"s":4,"e":5,"c":"pl-kos"}],[],[{"s":4,"e":7,"c":"pl-c"}],[{"s":0,"e":25,"c":"pl-c"}],[{"s":0,"e":7,"c":"pl-c"}],[{"s":0,"e":80,"c":"pl-c"}],[{"s":0,"e":7,"c":"pl-c"}],[{"s":0,"e":14,"c":"pl-c"}],[{"s":0,"e":7,"c":"pl-c"}],[{"s":4,"e":10,"c":"pl-k"},{"s":11,"e":16,"c":"pl-en"},{"s":16,"e":17,"c":"pl-kos"},{"s":17,"e":18,"c":"pl-kos"},{"s":19,"e":20,"c":"pl-kos"}],[{"s":8,"e":12,"c":"pl-smi"},{"s":12,"e":13,"c":"pl-kos"},{"s":13,"e":16,"c":"pl-c1"},{"s":16,"e":17,"c":"pl-kos"},{"s":17,"e":26,"c":"pl-en"},{"s":26,"e":27,"c":"pl-kos"},{"s":27,"e":28,"c":"pl-c1"},{"s":28,"e":29,"c":"pl-kos"},{"s":30,"e":31,"c":"pl-c1"},{"s":31,"e":32,"c":"pl-kos"},{"s":33,"e":37,"c":"pl-smi"},{"s":37,"e":38,"c":"pl-kos"},{"s":38,"e":48,"c":"pl-c1"},{"s":48,"e":49,"c":"pl-kos"},{"s":50,"e":54,"c":"pl-smi"},{"s":54,"e":55,"c":"pl-kos"},{"s":55,"e":66,"c":"pl-c1"},{"s":66,"e":67,"c":"pl-kos"},{"s":67,"e":68,"c":"pl-kos"}],[{"s":4,"e":5,"c":"pl-kos"}],[{"s":0,"e":1,"c":"pl-kos"}],[],[{"s":0,"e":6,"c":"pl-k"},{"s":7,"e":14,"c":"pl-k"},{"s":15,"e":22,"c":"pl-v"},{"s":22,"e":23,"c":"pl-kos"}]],"colorizedLines":null,"csv":null,"csvError":null,"dependabotInfo":{"showConfigurationBanner":false,"configFilePath":null,"networkDependabotPath":"/nighthawkcoders/portfolio_2025/network/updates","dismissConfigurationNoticePath":"/settings/dismiss-notice/dependabot_configuration_notice","configurationNoticeDismissed":null},"displayName":"GameEnv.js","displayUrl":"https://github.com/nighthawkcoders/portfolio_2025/blob/main/assets/js/rpg/GameEnv.js?raw=true","headerInfo":{"blobSize":"3.64 KB","deleteTooltip":"You must be signed in to make or propose changes","editTooltip":"You must be signed in to make or propose changes","ghDesktopPath":"https://desktop.github.com","isGitLfs":false,"onBranch":true,"shortPath":"81b88f4","siteNavLoginPath":"/login?return_to=https%3A%2F%2Fgithub.com%2Fnighthawkcoders%2Fportfolio_2025%2Fblob%2Fmain%2Fassets%2Fjs%2Frpg%2FGameEnv.js","isCSV":false,"isRichtext":false,"toc":null,"lineInfo":{"truncatedLoc":"123","truncatedSloc":"114"},"mode":"file"},"image":false,"isCodeownersFile":null,"isPlain":false,"isValidLegacyIssueTemplate":false,"issueTemplate":null,"discussionTemplate":null,"language":"JavaScript","languageID":183,"large":false,"planSupportInfo":{"repoIsFork":null,"repoOwnedByCurrentUser":null,"requestFullPath":"/nighthawkcoders/portfolio_2025/blob/main/assets/js/rpg/GameEnv.js","showFreeOrgGatedFeatureMessage":null,"showPlanSupportBanner":null,"upgradeDataAttributes":null,"upgradePath":null},"publishBannersInfo":{"dismissActionNoticePath":"/settings/dismiss-notice/publish_action_from_dockerfile","releasePath":"/nighthawkcoders/portfolio_2025/releases/new?marketplace=true","showPublishActionBanner":false},"rawBlobUrl":"https://github.com/nighthawkcoders/portfolio_2025/raw/refs/heads/main/assets/js/rpg/GameEnv.js","renderImageOrRaw":false,"richText":null,"renderedFileInfo":null,"shortPath":null,"symbolsEnabled":true,"tabSize":8,"topBannersInfo":{"overridingGlobalFundingFile":false,"globalPreferredFundingPath":null,"showInvalidCitationWarning":false,"citationHelpUrl":"https://docs.github.com/github/creating-cloning-and-archiving-repositories/creating-a-repository-on-github/about-citation-files","actionsOnboardingTip":null},"truncated":false,"viewable":true,"workflowRedirectUrl":null,"symbols":{"timed_out":false,"not_analyzed":false,"symbols":[{"name":"GameEnv","kind":"class","ident_start":1055,"ident_end":1062,"extent_start":1049,"extent_end":3699,"fully_qualified_name":"GameEnv","ident_utf16":{"start":{"line_number":20,"utf16_col":6},"end":{"line_number":20,"utf16_col":13}},"extent_utf16":{"start":{"line_number":20,"utf16_col":0},"end":{"line_number":120,"utf16_col":1}}},{"name":"constructor","kind":"method","ident_start":1371,"ident_end":1382,"extent_start":1371,"extent_end":1474,"fully_qualified_name":"GameEnv.constructor","ident_utf16":{"start":{"line_number":34,"utf16_col":4},"end":{"line_number":34,"utf16_col":15}},"extent_utf16":{"start":{"line_number":34,"utf16_col":4},"end":{"line_number":36,"utf16_col":5}}},{"name":"create","kind":"method","ident_start":1845,"ident_end":1851,"extent_start":1838,"extent_end":2074,"fully_qualified_name":"GameEnv.create","ident_utf16":{"start":{"line_number":47,"utf16_col":11},"end":{"line_number":47,"utf16_col":17}},"extent_utf16":{"start":{"line_number":47,"utf16_col":4},"end":{"line_number":54,"utf16_col":5}}},{"name":"setCanvas","kind":"method","ident_start":2187,"ident_end":2196,"extent_start":2180,"extent_end":2316,"fully_qualified_name":"GameEnv.setCanvas","ident_utf16":{"start":{"line_number":61,"utf16_col":11},"end":{"line_number":61,"utf16_col":20}},"extent_utf16":{"start":{"line_number":61,"utf16_col":4},"end":{"line_number":64,"utf16_col":5}}},{"name":"setTop","kind":"method","ident_start":2438,"ident_end":2444,"extent_start":2431,"extent_end":2564,"fully_qualified_name":"GameEnv.setTop","ident_utf16":{"start":{"line_number":71,"utf16_col":11},"end":{"line_number":71,"utf16_col":17}},"extent_utf16":{"start":{"line_number":71,"utf16_col":4},"end":{"line_number":74,"utf16_col":5}}},{"name":"setBottom","kind":"method","ident_start":2689,"ident_end":2698,"extent_start":2682,"extent_end":2821,"fully_qualified_name":"GameEnv.setBottom","ident_utf16":{"start":{"line_number":81,"utf16_col":11},"end":{"line_number":81,"utf16_col":20}},"extent_utf16":{"start":{"line_number":81,"utf16_col":4},"end":{"line_number":84,"utf16_col":5}}},{"name":"size","kind":"method","ident_start":2938,"ident_end":2942,"extent_start":2931,"extent_end":3300,"fully_qualified_name":"GameEnv.size","ident_utf16":{"start":{"line_number":91,"utf16_col":11},"end":{"line_number":91,"utf16_col":15}},"extent_utf16":{"start":{"line_number":91,"utf16_col":4},"end":{"line_number":99,"utf16_col":5}}},{"name":"resize","kind":"method","ident_start":3407,"ident_end":3413,"extent_start":3400,"extent_end":3446,"fully_qualified_name":"GameEnv.resize","ident_utf16":{"start":{"line_number":106,"utf16_col":11},"end":{"line_number":106,"utf16_col":17}},"extent_utf16":{"start":{"line_number":106,"utf16_col":4},"end":{"line_number":108,"utf16_col":5}}},{"name":"clear","kind":"method","ident_start":3613,"ident_end":3618,"extent_start":3606,"extent_end":3697,"fully_qualified_name":"GameEnv.clear","ident_utf16":{"start":{"line_number":117,"utf16_col":11},"end":{"line_number":117,"utf16_col":16}},"extent_utf16":{"start":{"line_number":117,"utf16_col":4},"end":{"line_number":119,"utf16_col":5}}}]}},"copilotInfo":null,"copilotAccessAllowed":false,"csrf_tokens":{"/nighthawkcoders/portfolio_2025/branches":{"post":"LXbJ7ANAdewlzRd14DbW6jmVreylVybQbtW1xrOZj9wFvtgXZUXqT-NXU3ZjN7EluUkRiLQsTbKM1pFRceX_Bg"},"/repos/preferences":{"post":"MO30IHUzvcSh5RktlbroW5YHSuWfYAujsvAqfz-VoSsCTY5Mc9gSKfTvf2_2-uhqsX9VJYrb56Uhzl6Clt5_sA"}}},"title":"portfolio_2025/assets/js/rpg/GameEnv.js at main · nighthawkcoders/portfolio_2025","appPayload":{"helpUrl":"https://docs.github.com","findFileWorkerPath":"/assets-cdn/worker/find-file-worker-1583894afd38.js","findInFileWorkerPath":"/assets-cdn/worker/find-in-file-worker-03b87d52cf57.js","githubDevUrl":null,"enabled_features":{"code_nav_ui_events":false,"overview_shared_code_dropdown_button":false,"react_blob_overlay":false,"copilot_conversational_ux_embedding_update":false,"copilot_smell_icebreaker_ux":true,"copilot_workspace":false}}}</script>
...
</style><meta data-hydrostats="publish"/> <!-- --> <!-- --> <button hidden="" data-testid="header-permalink-button" data-hotkey-scope="read-only-cursor-text-area"></button><button hidden=""></button><div><div style="--sticky-pane-height:100vh" class="Box-sc-g0xbh4-0 hOfjFo"><div class="Box-sc-g0xbh4-0 oDGAe"><div class="Box-sc-g0xbh4-0 kowOcT"><div tabindex="0" class="Box-sc-g0xbh4-0 gISSDQ"><div class="Box-sc-g0xbh4-0 fLEPlD"><div class="Box-sc-g0xbh4-0 hPvFuC"></div><div style="--pane-width:320px" class="Box-sc-g0xbh4-0 fFSoPl"></div><div class="Box-sc-g0xbh4-0 bTBnTW"><div role="slider" aria-label="Draggable pane splitter" aria-valuemin="0" aria-valuemax="0" aria-valuenow="0" aria-valuetext="Pane width 0 pixels" tabindex="0" class="Box-sc-g0xbh4-0 bHLmSv"></div></div></div></div><div class="Box-sc-g0xbh4-0 iKqMNA"><div class="Box-sc-g0xbh4-0"></div><div class="Box-sc-g0xbh4-0 FxAyp"><div data-selector="repos-split-pane-content" tabindex="0" class="Box-sc-g0xbh4-0 leYMvG"><div class="Box-sc-g0xbh4-0 KMPzq"><div class="Box-sc-g0xbh4-0 hfKjHv container"><div class="px-3 pt-3 pb-0" id="StickyHeader"><div class="Box-sc-g0xbh4-0 gZWyZE"><div class="Box-sc-g0xbh4-0 dwYKDk"><div class="Box-sc-g0xbh4-0 ibcGmb react-code-view-header-wrap--narrow"><div class="Box-sc-g0xbh4-0 hKaEJF"><h2 class="Heading__StyledHeading-sc-1c1dgg0-0 ixDjro"><button style="--button-color:fg.muted" type="button" aria-label="Expand file tree" data-testid="expand-file-tree-button-mobile" class="types__StyledButton-sc-ws60qy-0 kBQCgV" data-loading="false" data-size="medium" aria-describedby=":Rld9lab:-loading-announcement"><span data-component="buttonContent" class="Box-sc-g0xbh4-0 gUkoLg"><span data-component="leadingVisual" class="Box-sc-g0xbh4-0 hzSPyu"><svg aria-hidden="true" focusable="false" class="octicon octicon-arrow-left" viewBox="0 0 16 16" width="16" height="16" fill="currentColor" style="display:inline-block;user-select:none;vertical-align:text-bottom;overflow:visible"><path d="M7.78 12.53a.75.75 0 0 1-1.06 0L2.47 8.28a.75.75 0 0 1 0-1.06l4.25-4.25a.751.751 0 0 1 1.042.018.751.751 0 0 1 .018 1.042L4.81 7h7.44a.75.75 0 0 1 0 1.5H4.81l2.97 2.97a.75.75 0 0 1 0 1.06Z"></path></svg></span><span data-component="text">Files</span></span></button><span role="tooltip" aria-label="Expand file tree" id="expand-button-file-tree-button" class="Tooltip__TooltipBase-sc-17tf59c-0 hWlpPn tooltipped-se"><button data-component="IconButton" type="button" data-testid="expand-file-tree-button" aria-controls="repos-file-tree" class="types__StyledButton-sc-ws60qy-0 LXqWf prc-Button-IconButton-szpyj" data-loading="false" data-no-visuals="true" data-size="medium" aria-describedby=":R35d9lab:-loading-announcement" aria-labelledby="expand-button-file-tree-button"><svg aria-hidden="true" focusable="false" class="octicon octicon-sidebar-collapse" viewBox="0 0 16 16" width="16" height="16" fill="currentColor" style="display:inline-block;user-select:none;vertical-align:text-bottom;overflow:visible"><path d="M6.823 7.823a.25.25 0 0 1 0 .354l-2.396 2.396A.25.25 0 0 1 4 10.396V5.604a.25.25 0 0 1 .427-.177Z"></path><path d="M1.75 0h12.5C15.216 0 16 .784 16 1.75v12.5A1.75 1.75 0 0 1 14.25 16H1.75A1.75 1.75 0 0 1 0 14.25V1.75C0 .784.784 0 1.75 0ZM1.5 1.75v12.5c0 .138.112.25.25.25H9.5v-13H1.75a.25.25 0 0 0-.25.25ZM11 14.5h3.25a.25.25 0 0 0 .25-.25V1.75a.25.25 0 0 0-.25-.25H11Z"></path></svg></button></span><button hidden="" data-testid="" data-hotkey-scope="read-only-cursor-text-area"></button></h2></div><div class="react-code-view-header-mb--narrow mr-2"><button type="button" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-label="main branch" data-testid="anchor-button" class="types__StyledButton-sc-ws60qy-0 iQGjqs ref-selector-class" data-loading="false" data-size="medium" aria-describedby="branch-picker-repos-header-ref-selector-wide-loading-announcement" id="branch-picker-repos-header-ref-selector-wide"><span data-component="buttonContent" class="Box-sc-g0xbh4-0 gUkoLg"><span data-component="text"><div class="Box-sc-g0xbh4-0 bZBlpz"><div class="Box-sc-g0xbh4-0 lhTYNA"><svg aria-hidden="true" focusable="false" class="octicon octicon-git-branch" viewBox="0 0 16 16" width="16" height="16" fill="currentColor" style="display:inline-block;user-select:none;vertical-align:text-bottom;overflow:visible"><path d="M9.5 3.25a2.25 2.25 0 1 1 3 2.122V6A2.5 2.5 0 0 1 10 8.5H6a1 1 0 0 0-1 1v1.128a2.251 2.251 0 1 1-1.5 0V5.372a2.25 2.25 0 1 1 1.5 0v1.836A2.493 2.493 0 0 1 6 7h4a1 1 0 0 0 1-1v-.628A2.25 2.25 0 0 1 9.5 3.25Zm-6 0a.75.75 0 1 0 1.5 0 .75.75 0 0 0-1.5 0Zm8.25-.75a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5ZM4.25 12a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Z"></path></svg></div><div class="Box-sc-g0xbh4-0 dbrgmi ref-selector-button-text-container"><span class="Text__StyledText-sc-17v1xeu-0 eMMFM"> <!-- -->main</span></div></div></span><span data-component="trailingVisual" class="Box-sc-g0xbh4-0 hzSPyu"><svg aria-hidden="true" focusable="false" class="octicon octicon-triangle-down" viewBox="0 0 16 16" width="16" height="16" fill="currentColor" style="display:inline-block;user-select:none;vertical-align:text-bottom;overflow:visible"><path d="m4.427 7.427 3.396 3.396a.25.25 0 0 0 .354 0l3.396-3.396A.25.25 0 0 0 11.396 7H4.604a.25.25 0 0 0-.177.427Z"></path></svg></span></span></button><button hidden="" data-hotkey-scope="read-only-cursor-text-area"></button></div><div class="Box-sc-g0xbh4-0 dHJiml react-code-view-header-mb--narrow"><div class="Box-sc-g0xbh4-0 cEytCf"><nav data-testid="breadcrumbs" aria-labelledby="repos-header-breadcrumb-heading" id="repos-header-breadcrumb" class="Box-sc-g0xbh4-0 fzFXnm"><h2 class="Heading__StyledHeading-sc-1c1dgg0-0 jHwwdn sr-only" data-testid="screen-reader-heading" id="repos-header-breadcrumb-heading">Breadcrumbs</h2><ol class="Box-sc-g0xbh4-0 iMnkmv"><li class="Box-sc-g0xbh4-0 ghzDag"><a class="Link__StyledLink-sc-14289xe-0 iuEHTz" sx="[object Object]" data-testid="breadcrumbs-repo-link" href="/nighthawkcoders/portfolio_2025/tree/main">portfolio_2025</a></li><li class="Box-sc-g0xbh4-0 ghzDag"><span class="Text__StyledText-sc-17v1xeu-0 HlHVj" aria-hidden="true">/</span><a class="Link__StyledLink-sc-14289xe-0 jjcbrl" sx="[object Object]" href="/nighthawkcoders/portfolio_2025/tree/main/assets">assets</a></li><li class="Box-sc-g0xbh4-0 ghzDag"><span class="Text__StyledText-sc-17v1xeu-0 HlHVj" aria-hidden="true">/</span><a class="Link__StyledLink-sc-14289xe-0 jjcbrl" sx="[object Object]" href="/nighthawkcoders/portfolio_2025/tree/main/assets/js">js</a></li><li class="Box-sc-g0xbh4-0 ghzDag"><span class="Text__StyledText-sc-17v1xeu-0 HlHVj" aria-hidden="true">/</span><a class="Link__StyledLink-sc-14289xe-0 jjcbrl" sx="[object Object]" href="/nighthawkcoders/portfolio_2025/tree/main/assets/js/rpg">rpg</a></li></ol></nav><div data-testid="breadcrumbs-filename" class="Box-sc-g0xbh4-0 ghzDag"><span class="Text__StyledText-sc-17v1xeu-0 HlHVj" aria-hidden="true">/</span><h1 class="Heading__StyledHeading-sc-1c1dgg0-0 leHNVT" tabindex="-1" id="file-name-id">GameEnv.js</h1></div><div aria-describedby=":R1td9lab:"><button data-component="IconButton" type="button" aria-label="Copy path" tabindex="0" class="types__StyledButton-sc-ws60qy-0 dPmZyJ prc-Button-IconButton-szpyj" data-loading="false" data-no-visuals="true" data-size="small" aria-describedby=":R7td9lab:-loading-announcement"><svg aria-hidden="true" focusable="false" class="octicon octicon-copy" viewBox="0 0 16 16" width="16" height="16" fill="currentColor" style="display:inline-block;user-select:none;vertical-align:text-bottom;overflow:visible"><path d="M0 6.75C0 5.784.784 5 1.75 5h1.5a.75.75 0 0 1 0 1.5h-1.5a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h7.5a.25.25 0 0 0 .25-.25v-1.5a.75.75 0 0 1 1.5 0v1.5A1.75 1.75 0 0 1 9.25 16h-7.5A1.75 1.75 0 0 1 0 14.25Z"></path><path d="M5 1.75C5 .784 5.784 0 6.75 0h7.5C15.216 0 16 .784 16 1.75v7.5A1.75 1.75 0 0 1 14.25 11h-7.5A1.75 1.75 0 0 1 5 9.25Zm1.75-.25a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h7.5a.25.25 0 0 0 .25-.25v-7.5a.25.25 0 0 0-.25-.25Z"></path></svg></button></div></div></div></div><div class="react-code-view-header-element--wide"><div class="Box-sc-g0xbh4-0 faNtbn"><div class="d-flex gap-2"> <div><div class="Box-sc-g0xbh4-0 fmQaBv"><span class="TextInputWrapper__TextInputBaseWrapper-sc-1mqhpbi-0 TextInputWrapper-sc-1mqhpbi-1 gwqFqs decvaq TextInput-wrapper" aria-busy="false"><span class="TextInput-icon"><svg aria-hidden="true" focusable="false" class="octicon octicon-search" viewBox="0 0 16 16" width="16" height="16" fill="currentColor" style="display:inline-block;user-select:none;vertical-align:text-bottom;overflow:visible"><path d="M10.68 11.74a6 6 0 0 1-7.922-8.982 6 6 0 0 1 8.982 7.922l3.04 3.04a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215ZM11.5 7a4.499 4.499 0 1 0-8.997 0A4.499 4.499 0 0 0 11.5 7Z"></path></svg></span><input type="text" aria-label="Go to file" role="combobox" aria-controls="file-results-list" aria-expanded="false" aria-haspopup="dialog" autoCorrect="off" spellcheck="false" placeholder="Go to file" data-component="input" class="UnstyledTextInput-sc-14ypya-0 kbCLEG" value=""/><span class="TextInput-icon"></span></span></div><button hidden="" data-testid="" data-hotkey-scope="read-only-cursor-text-area"></button><button hidden=""></button></div><button hidden="" data-testid="" data-hotkey-scope="read-only-cursor-text-area"></button><button hidden=""></button><button hidden="" data-testid="" data-hotkey-scope="read-only-cursor-text-area"></button><button hidden=""></button><button type="button" class="types__StyledButton-sc-ws60qy-0 iLfocZ" data-loading="false" data-no-visuals="true" data-size="medium" aria-describedby=":R2l6d9lab:-loading-announcement"><span data-component="buttonContent" class="Box-sc-g0xbh4-0 gUkoLg"><span data-component="text">Blame</span></span></button><button hidden="" data-testid="" data-hotkey-scope="read-only-cursor-text-area"></button><button data-component="IconButton" type="button" aria-label="More file actions" title="More file actions" data-testid="more-file-actions-button-nav-menu-wide" aria-haspopup="true" aria-expanded="false" tabindex="0" class="types__StyledButton-sc-ws60qy-0 JVsBq js-blob-dropdown-click prc-Button-IconButton-szpyj" data-loading="false" data-no-visuals="true" data-size="medium" aria-describedby=":R156d9lab:-loading-announcement" id=":R156d9lab:"><svg aria-hidden="true" focusable="false" class="octicon octicon-kebab-horizontal" viewBox="0 0 16 16" width="16" height="16" fill="currentColor" style="display:inline-block;user-select:none;vertical-align:text-bottom;overflow:visible"><path d="M8 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3ZM1.5 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Zm13 0a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path></svg></button> </div></div></div><div class="react-code-view-header-element--narrow"><div class="Box-sc-g0xbh4-0 faNtbn"><div class="d-flex gap-2"> <button hidden="" data-testid="" data-hotkey-scope="read-only-cursor-text-area"></button><button hidden=""></button><button hidden="" data-testid="" data-hotkey-scope="read-only-cursor-text-area"></button><button hidden=""></button><button type="button" class="types__StyledButton-sc-ws60qy-0 iLfocZ" data-loading="false" data-no-visuals="true" data-size="medium" aria-describedby=":R2l7d9lab:-loading-announcement"><span data-component="buttonContent" class="Box-sc-g0xbh4-0 gUkoLg"><span data-component="text">Blame</span></span></button><button hidden="" data-testid="" data-hotkey-scope="read-only-cursor-text-area"></button><button data-component="IconButton" type="button" aria-label="More file actions" title="More file actions" data-testid="more-file-actions-button-nav-menu-narrow" aria-haspopup="true" aria-expanded="false" tabindex="0" class="types__StyledButton-sc-ws60qy-0 JVsBq js-blob-dropdown-click prc-Button-IconButton-szpyj" data-loading="false" data-no-visuals="true" data-size="medium" aria-describedby=":R157d9lab:-loading-announcement" id=":R157d9lab:"><svg aria-hidden="true" focusable="false" class="octicon octicon-kebab-horizontal" viewBox="0 0 16 16" width="16" height="16" fill="currentColor" style="display:inline-block;user-select:none;vertical-align:text-bottom;overflow:visible"><path d="M8 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3ZM1.5 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Zm13 0a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path></svg></button> </div></div></div></div></div></div></div></div><div class="Box-sc-g0xbh4-0 dJxjrT react-code-view-bottom-padding"> <div class="Box-sc-g0xbh4-0 eFxKDQ"></div> <!-- --> <!-- --> </div><div class="Box-sc-g0xbh4-0 dJxjrT"> <!-- --> <!-- --> <button hidden="" data-testid="" data-hotkey-scope="read-only-cursor-text-area"></button><button hidden=""></button><div class="d-flex flex-column border rounded-2 mb-3 pl-1"><div class="Box-sc-g0xbh4-0 dzCJzi"><h2 class="Heading__StyledHeading-sc-1c1dgg0-0 jHwwdn sr-only" data-testid="screen-reader-heading">Latest commit</h2><div style="width:120px" class="Skeleton Skeleton--text" data-testid="loading"> </div><div class="d-flex flex-shrink-0 gap-2"><div data-testid="latest-commit-details" class="d-none d-sm-flex flex-items-center"></div><div class="d-flex gap-2"><h2 class="Heading__StyledHeading-sc-1c1dgg0-0 jHwwdn sr-only" data-testid="screen-reader-heading">History</h2><a href="/nighthawkcoders/portfolio_2025/commits/main/assets/js/rpg/GameEnv.js" class="types__StyledButton-sc-ws60qy-0 dPmZyJ d-none d-lg-flex LinkButton-module__code-view-link-button--xvCGA flex-items-center fgColor-default" data-loading="false" data-size="small" aria-describedby=":R5dlal9lab:-loading-announcement"><span data-component="buttonContent" class="Box-sc-g0xbh4-0 gUkoLg"><span data-component="leadingVisual" class="Box-sc-g0xbh4-0 hzSPyu"><svg aria-hidden="true" focusable="false" class="octicon octicon-history" viewBox="0 0 16 16" width="16" height="16" fill="currentColor" style="display:inline-block;user-select:none;vertical-align:text-bottom;overflow:visible"><path d="m.427 1.927 1.215 1.215a8.002 8.002 0 1 1-1.6 5.685.75.75 0 1 1 1.493-.154 6.5 6.5 0 1 0 1.18-4.458l1.358 1.358A.25.25 0 0 1 3.896 6H.25A.25.25 0 0 1 0 5.75V2.104a.25.25 0 0 1 .427-.177ZM7.75 4a.75.75 0 0 1 .75.75v2.992l2.028.812a.75.75 0 0 1-.557 1.392l-2.5-1A.751.751 0 0 1 7 8.25v-3.5A.75.75 0 0 1 7.75 4Z"></path></svg></span><span data-component="text"><span class="fgColor-default">History</span></span></span></a><div class="d-sm-none"></div><div class="d-flex d-lg-none"><span role="tooltip" aria-label="History" id="history-icon-button-tooltip" class="Tooltip__TooltipBase-sc-17tf59c-0 hWlpPn tooltipped-n"><a href="/nighthawkcoders/portfolio_2025/commits/main/assets/js/rpg/GameEnv.js" class="types__StyledButton-sc-ws60qy-0 dPmZyJ LinkButton-module__code-view-link-button--xvCGA flex-items-center fgColor-default" data-loading="false" data-size="small" aria-describedby=":Rpdlal9lab:-loading-announcement history-icon-button-tooltip"><span data-component="buttonContent" class="Box-sc-g0xbh4-0 gUkoLg"><span data-component="leadingVisual" class="Box-sc-g0xbh4-0 hzSPyu"><svg aria-hidden="true" focusable="false" class="octicon octicon-history" viewBox="0 0 16 16" width="16" height="16" fill="currentColor" style="display:inline-block;user-select:none;vertical-align:text-bottom;overflow:visible"><path d="m.427 1.927 1.215 1.215a8.002 8.002 0 1 1-1.6 5.685.75.75 0 1 1 1.493-.154 6.5 6.5 0 1 0 1.18-4.458l1.358 1.358A.25.25 0 0 1 3.896 6H.25A.25.25 0 0 1 0 5.75V2.104a.25.25 0 0 1 .427-.177ZM7.75 4a.75.75 0 0 1 .75.75v2.992l2.028.812a.75.75 0 0 1-.557 1.392l-2.5-1A.751.751 0 0 1 7 8.25v-3.5A.75.75 0 0 1 7.75 4Z"></path></svg></span></span></a></span></div></div></div></div></div><div class="Box-sc-g0xbh4-0 ldRxiI"><div class="Box-sc-g0xbh4-0 fVkfyA container"><div class="Box-sc-g0xbh4-0 gNAmSV react-code-size-details-banner"><div class="Box-sc-g0xbh4-0 jNEwzY react-code-size-details-banner"><div class="Box-sc-g0xbh4-0 bsDwxw text-mono"><div title="3.64 KB" data-testid="blob-size" class="Truncate__StyledTruncate-sc-23o1d2-0 eAtkQz"><span>123 lines (114 loc) · 3.64 KB</span></div></div></div></div><div class="Box-sc-g0xbh4-0 jdLMhu react-blob-view-header-sticky" id="repos-sticky-header"><div class="Box-sc-g0xbh4-0 tOISc"><div class="react-blob-sticky-header"><div class="Box-sc-g0xbh4-0 hqwSEx"><div class="Box-sc-g0xbh4-0 bDVoEr"><div class="Box-sc-g0xbh4-0 kYLlPM"><div class="Box-sc-g0xbh4-0 gYjEmn"><button type="button" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-label="main branch" data-testid="anchor-button" class="types__StyledButton-sc-ws60qy-0 iQGjqs ref-selector-class" data-loading="false" data-size="medium" aria-describedby="branch-picker-repos-header-ref-selector-loading-announcement" id="branch-picker-repos-header-ref-selector"><span data-component="buttonContent" class="Box-sc-g0xbh4-0 gUkoLg"><span data-component="text"><div class="Box-sc-g0xbh4-0 bZBlpz"><div class="Box-sc-g0xbh4-0 lhTYNA"><svg aria-hidden="true" focusable="false" class="octicon octicon-git-branch" viewBox="0 0 16 16" width="16" height="16" fill="currentColor" style="display:inline-block;user-select:none;vertical-align:text-bottom;overflow:visible"><path d="M9.5 3.25a2.25 2.25 0 1 1 3 2.122V6A2.5 2.5 0 0 1 10 8.5H6a1 1 0 0 0-1 1v1.128a2.251 2.251 0 1 1-1.5 0V5.372a2.25 2.25 0 1 1 1.5 0v1.836A2.493 2.493 0 0 1 6 7h4a1 1 0 0 0 1-1v-.628A2.25 2.25 0 0 1 9.5 3.25Zm-6 0a.75.75 0 1 0 1.5 0 .75.75 0 0 0-1.5 0Zm8.25-.75a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5ZM4.25 12a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Z"></path></svg></div><div class="Box-sc-g0xbh4-0 dbrgmi ref-selector-button-text-container"><span class="Text__StyledText-sc-17v1xeu-0 eMMFM"> <!-- -->main</span></div></div></span><span data-component="trailingVisual" class="Box-sc-g0xbh4-0 hzSPyu"><svg aria-hidden="true" focusable="false" class="octicon octicon-triangle-down" viewBox="0 0 16 16" width="16" height="16" fill="currentColor" style="display:inline-block;user-select:none;vertical-align:text-bottom;overflow:visible"><path d="m4.427 7.427 3.396 3.396a.25.25 0 0 0 .354 0l3.396-3.396A.25.25 0 0 0 11.396 7H4.604a.25.25 0 0 0-.177.427Z"></path></svg></span></span></button><button hidden="" data-hotkey-scope="read-only-cursor-text-area"></button></div><div class="Box-sc-g0xbh4-0 kGqOLL"><div class="Box-sc-g0xbh4-0 fHind"><nav data-testid="breadcrumbs" aria-labelledby="sticky-breadcrumb-heading" id="sticky-breadcrumb" class="Box-sc-g0xbh4-0 fzFXnm"><h2 class="Heading__StyledHeading-sc-1c1dgg0-0 jHwwdn sr-only" data-testid="screen-reader-heading" id="sticky-breadcrumb-heading">Breadcrumbs</h2><ol class="Box-sc-g0xbh4-0 iMnkmv"><li class="Box-sc-g0xbh4-0 ghzDag"><a class="Link__StyledLink-sc-14289xe-0 iuEHTz" sx="[object Object]" data-testid="breadcrumbs-repo-link" href="/nighthawkcoders/portfolio_2025/tree/main">portfolio_2025</a></li><li class="Box-sc-g0xbh4-0 ghzDag"><span class="Text__StyledText-sc-17v1xeu-0 lauzFl" aria-hidden="true">/</span><a class="Link__StyledLink-sc-14289xe-0 jjcbrl" sx="[object Object]" href="/nighthawkcoders/portfolio_2025/tree/main/assets">assets</a></li><li class="Box-sc-g0xbh4-0 ghzDag"><span class="Text__StyledText-sc-17v1xeu-0 lauzFl" aria-hidden="true">/</span><a class="Link__StyledLink-sc-14289xe-0 jjcbrl" sx="[object Object]" href="/nighthawkcoders/portfolio_2025/tree/main/assets/js">js</a></li><li class="Box-sc-g0xbh4-0 ghzDag"><span class="Text__StyledText-sc-17v1xeu-0 lauzFl" aria-hidden="true">/</span><a class="Link__StyledLink-sc-14289xe-0 jjcbrl" sx="[object Object]" href="/nighthawkcoders/portfolio_2025/tree/main/assets/js/rpg">rpg</a></li></ol></nav><div data-testid="breadcrumbs-filename" class="Box-sc-g0xbh4-0 ghzDag"><span class="Text__StyledText-sc-17v1xeu-0 lauzFl" aria-hidden="true">/</span><h1 class="Heading__StyledHeading-sc-1c1dgg0-0 gbqGBV" tabindex="-1" id="sticky-file-name-id">GameEnv.js</h1></div></div></div></div><button style="--button-color:fg.default" type="button" class="types__StyledButton-sc-ws60qy-0 fwExmK" data-loading="false" data-size="small" aria-describedby=":Riptal9lab:-loading-announcement"><span data-component="buttonContent" class="Box-sc-g0xbh4-0 gUkoLg"><span data-component="leadingVisual" class="Box-sc-g0xbh4-0 hzSPyu"><svg aria-hidden="true" focusable="false" class="octicon octicon-arrow-up" viewBox="0 0 16 16" width="16" height="16" fill="currentColor" style="display:inline-block;user-select:none;vertical-align:text-bottom;overflow:visible"><path d="M3.47 7.78a.75.75 0 0 1 0-1.06l4.25-4.25a.75.75 0 0 1 1.06 0l4.25 4.25a.751.751 0 0 1-.018 1.042.751.751 0 0 1-1.042.018L9 4.81v7.44a.75.75 0 0 1-1.5 0V4.81L4.53 7.78a.75.75 0 0 1-1.06 0Z"></path></svg></span><span data-component="text">Top</span></span></button></div></div></div><div class="Box-sc-g0xbh4-0 kTvpNk"><h2 class="Heading__StyledHeading-sc-1c1dgg0-0 jHwwdn sr-only" data-testid="screen-reader-heading">File metadata and controls</h2><div class="Box-sc-g0xbh4-0 iNMjfP"><ul aria-label="File view" class="SegmentedControl__SegmentedControlList-sc-1rzig82-0 lawgDG"><li class="Box-sc-g0xbh4-0 fefCSX"><button aria-current="true" type="button" class="SegmentedControlButton__SegmentedControlButtonStyled-sc-8lkgxl-0 icWBNR"><span class="segmentedControl-content"><div class="Box-sc-g0xbh4-0 segmentedControl-text">Code</div></span></button></li><li class="Box-sc-g0xbh4-0 idgUkN"><button aria-current="false" type="button" class="SegmentedControlButton__SegmentedControlButtonStyled-sc-8lkgxl-0 gLclPK"><span class="segmentedControl-content"><div class="Box-sc-g0xbh4-0 segmentedControl-text">Blame</div></span></button></li></ul><button hidden="" data-testid="" data-hotkey-scope="read-only-cursor-text-area"></button><button hidden="" data-testid="" data-hotkey-scope="read-only-cursor-text-area"></button><div class="Box-sc-g0xbh4-0 jNEwzY react-code-size-details-in-header"><div class="Box-sc-g0xbh4-0 bsDwxw text-mono"><div title="3.64 KB" data-testid="blob-size" class="Truncate__StyledTruncate-sc-23o1d2-0 eAtkQz"><span>123 lines (114 loc) · 3.64 KB</span></div></div></div></div><div class="Box-sc-g0xbh4-0 kcLCKF"><div class="Box-sc-g0xbh4-0 kVWtTz react-blob-header-edit-and-raw-actions"><div class="ButtonGroup-sc-1gxhls1-0 kiEfKw"><a href="https://github.com/nighthawkcoders/portfolio_2025/raw/refs/heads/main/assets/js/rpg/GameEnv.js" data-testid="raw-button" class="types__StyledButton-sc-ws60qy-0 ifVXZX" data-loading="false" data-no-visuals="true" data-size="small" aria-describedby=":R5csptal9lab:-loading-announcement"><span data-component="buttonContent" class="Box-sc-g0xbh4-0 gUkoLg"><span data-component="text">Raw</span></span></a><button data-component="IconButton" type="button" aria-label="Copy raw content" data-testid="copy-raw-button" class="types__StyledButton-sc-ws60qy-0 gGdPyq prc-Button-IconButton-szpyj" data-loading="false" data-no-visuals="true" data-size="small" aria-describedby=":Rpcsptal9lab:-loading-announcement"><svg aria-hidden="true" focusable="false" class="octicon octicon-copy" viewBox="0 0 16 16" width="16" height="16" fill="currentColor" style="display:inline-block;user-select:none;vertical-align:text-bottom;overflow:visible"><path d="M0 6.75C0 5.784.784 5 1.75 5h1.5a.75.75 0 0 1 0 1.5h-1.5a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h7.5a.25.25 0 0 0 .25-.25v-1.5a.75.75 0 0 1 1.5 0v1.5A1.75 1.75 0 0 1 9.25 16h-7.5A1.75 1.75 0 0 1 0 14.25Z"></path><path d="M5 1.75C5 .784 5.784 0 6.75 0h7.5C15.216 0 16 .784 16 1.75v7.5A1.75 1.75 0 0 1 14.25 11h-7.5A1.75 1.75 0 0 1 5 9.25Zm1.75-.25a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h7.5a.25.25 0 0 0 .25-.25v-7.5a.25.25 0 0 0-.25-.25Z"></path></svg></button><span role="tooltip" aria-label="Download raw file" id=":Rdcsptal9lab:" class="Tooltip__TooltipBase-sc-17tf59c-0 hWlpPn tooltipped-n"><button data-component="IconButton" type="button" aria-label="Download raw content" data-testid="download-raw-button" class="types__StyledButton-sc-ws60qy-0 dOuZvu prc-Button-IconButton-szpyj" data-loading="false" data-no-visuals="true" data-size="small" aria-describedby=":Rtcsptal9lab:-loading-announcement"><svg aria-hidden="true" focusable="false" class="octicon octicon-download" viewBox="0 0 16 16" width="16" height="16" fill="currentColor" style="display:inline-block;user-select:none;vertical-align:text-bottom;overflow:visible"><path d="M2.75 14A1.75 1.75 0 0 1 1 12.25v-2.5a.75.75 0 0 1 1.5 0v2.5c0 .138.112.25.25.25h10.5a.25.25 0 0 0 .25-.25v-2.5a.75.75 0 0 1 1.5 0v2.5A1.75 1.75 0 0 1 13.25 14Z"></path><path d="M7.25 7.689V2a.75.75 0 0 1 1.5 0v5.689l1.97-1.969a.749.749 0 1 1 1.06 1.06l-3.25 3.25a.749.749 0 0 1-1.06 0L4.22 6.78a.749.749 0 1 1 1.06-1.06l1.97 1.969Z"></path></svg></button></span></div><button hidden="" data-testid="raw-button-shortcut" data-hotkey-scope="read-only-cursor-text-area"></button><button hidden="" data-testid="copy-raw-button-shortcut" data-hotkey-scope="read-only-cursor-text-area"></button><button hidden="" data-testid="download-raw-button-shortcut" data-hotkey-scope="read-only-cursor-text-area"></button></div><span role="tooltip" aria-label="Open symbols panel" id=":R5sptal9lab:" class="Tooltip__TooltipBase-sc-17tf59c-0 hWlpPn tooltipped-nw"><button data-component="IconButton" type="button" aria-label="Symbols" aria-pressed="false" aria-expanded="false" aria-controls="symbols-pane" data-testid="symbols-button" class="types__StyledButton-sc-ws60qy-0 iZkvjn prc-Button-IconButton-szpyj" data-loading="false" data-no-visuals="true" data-size="small" aria-describedby="symbols-button-loading-announcement" id="symbols-button"><svg aria-hidden="true" focusable="false" class="octicon octicon-code-square" viewBox="0 0 16 16" width="16" height="16" fill="currentColor" style="display:inline-block;user-select:none;vertical-align:text-bottom;overflow:visible"><path d="M0 1.75C0 .784.784 0 1.75 0h12.5C15.216 0 16 .784 16 1.75v12.5A1.75 1.75 0 0 1 14.25 16H1.75A1.75 1.75 0 0 1 0 14.25Zm1.75-.25a.25.25 0 0 0-.25.25v12.5c0 .138.112.25.25.25h12.5a.25.25 0 0 0 .25-.25V1.75a.25.25 0 0 0-.25-.25Zm7.47 3.97a.75.75 0 0 1 1.06 0l2 2a.75.75 0 0 1 0 1.06l-2 2a.749.749 0 0 1-1.275-.326.749.749 0 0 1 .215-.734L10.69 8 9.22 6.53a.75.75 0 0 1 0-1.06ZM6.78 6.53 5.31 8l1.47 1.47a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215l-2-2a.75.75 0 0 1 0-1.06l2-2a.751.751 0 0 1 1.042.018.751.751 0 0 1 .018 1.042Z"></path></svg></button></span><div class="react-blob-header-edit-and-raw-actions-combined"><button data-component="IconButton" type="button" aria-label="Edit and raw actions" title="More file actions" data-testid="more-file-actions-button" aria-haspopup="true" aria-expanded="false" tabindex="0" class="types__StyledButton-sc-ws60qy-0 ggSvLP js-blob-dropdown-click prc-Button-IconButton-szpyj" data-loading="false" data-no-visuals="true" data-size="small" aria-describedby=":Rnsptal9lab:-loading-announcement" id=":Rnsptal9lab:"><svg aria-hidden="true" focusable="false" class="octicon octicon-kebab-horizontal" viewBox="0 0 16 16" width="16" height="16" fill="currentColor" style="display:inline-block;user-select:none;vertical-align:text-bottom;overflow:visible"><path d="M8 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3ZM1.5 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Zm13 0a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path></svg></button></div></div></div></div><div></div></div><div class="Box-sc-g0xbh4-0 hGyMdv"><section aria-labelledby="file-name-id-wide file-name-id-mobile" class="Box-sc-g0xbh4-0 dceWRL"><div class="Box-sc-g0xbh4-0 dGXHv"><div id="highlighted-line-menu-positioner" class="position-relative"><div id="copilot-button-positioner" class="Box-sc-g0xbh4-0 bpDFns"><div class="Box-sc-g0xbh4-0 iJOeCH"><div class="Box-sc-g0xbh4-0 jewUnv react-code-file-contents" role="presentation" aria-hidden="true" data-tab-size="8" data-paste-markdown-skip="true" data-hpc="true"><div class="react-line-numbers" style="pointer-events:auto"><div data-line-number="1" class="react-line-number react-code-text" style="padding-right:16px">1</div><div data-line-number="2" class="react-line-number react-code-text" style="padding-right:16px">2</div><div data-line-number="3" class="react-line-number react-code-text" style="padding-right:16px">3</div><div data-line-number="4" class="react-line-number react-code-text" style="padding-right:16px">4</div><div data-line-number="5" class="react-line-number react-code-text" style="padding-right:16px">5</div><div data-line-number="6" class="react-line-number react-code-text" style="padding-right:16px">6</div><div data-line-number="7" class="react-line-number react-code-text" style="padding-right:16px">7</div><div data-line-number="8" class="react-line-number react-code-text" style="padding-right:16px">8</div><div data-line-number="9" class="react-line-number react-code-text" style="padding-right:16px">9</div><div data-line-number="10" class="react-line-number react-code-text" style="padding-right:16px">10</div><div data-line-number="11" class="react-line-number react-code-text" style="padding-right:16px">11</div><div data-line-number="12" class="react-line-number react-code-text" style="padding-right:16px">12</div><div data-line-number="13" class="react-line-number react-code-text" style="padding-right:16px">13</div><div data-line-number="14" class="react-line-number react-code-text" style="padding-right:16px">14</div><div data-line-number="15" class="react-line-number react-code-text" style="padding-right:16px">15</div><div data-line-number="16" class="react-line-number react-code-text" style="padding-right:16px">16</div><div data-line-number="17" class="react-line-number react-code-text" style="padding-right:16px">17</div><div data-line-number="18" class="react-line-number react-code-text" style="padding-right:16px">18</div><div data-line-number="19" class="react-line-number react-code-text" style="padding-right:16px">19</div><div data-line-number="20" class="react-line-number react-code-text" style="padding-right:16px">20</div><div data-line-number="21" class="react-line-number react-code-text" style="padding-right:16px">21<span class="Box-sc-g0xbh4-0 cJGaMs"><div aria-label="Collapse code section" role="button" class="Box-sc-g0xbh4-0 iGLarr"><svg aria-hidden="true" focusable="false" class="Octicon-sc-9kayk9-0" viewBox="0 0 16 16" width="16" height="16" fill="currentColor" style="display:inline-block;user-select:none;vertical-align:text-bottom;overflow:visible"><path d="M12.78 5.22a.749.749 0 0 1 0 1.06l-4.25 4.25a.749.749 0 0 1-1.06 0L3.22 6.28a.749.749 0 1 1 1.06-1.06L8 8.939l3.72-3.719a.749.749 0 0 1 1.06 0Z"></path></svg></div></span></div><div data-line-number="22" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">22</div><div data-line-number="23" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">23</div><div data-line-number="24" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">24</div><div data-line-number="25" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">25</div><div data-line-number="26" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">26</div><div data-line-number="27" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">27</div><div data-line-number="28" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">28</div><div data-line-number="29" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">29</div><div data-line-number="30" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">30</div><div data-line-number="31" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">31</div><div data-line-number="32" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">32</div><div data-line-number="33" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">33</div><div data-line-number="34" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">34</div><div data-line-number="35" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">35</div><div data-line-number="36" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">36</div><div data-line-number="37" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">37</div><div data-line-number="38" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">38</div><div data-line-number="39" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">39</div><div data-line-number="40" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">40</div><div data-line-number="41" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">41</div><div data-line-number="42" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">42</div><div data-line-number="43" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">43</div><div data-line-number="44" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">44</div><div data-line-number="45" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">45</div><div data-line-number="46" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">46</div><div data-line-number="47" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">47</div><div data-line-number="48" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">48<span class="Box-sc-g0xbh4-0 cJGaMs"><div aria-label="Collapse code section" role="button" class="Box-sc-g0xbh4-0 iGLarr"><svg aria-hidden="true" focusable="false" class="Octicon-sc-9kayk9-0" viewBox="0 0 16 16" width="16" height="16" fill="currentColor" style="display:inline-block;user-select:none;vertical-align:text-bottom;overflow:visible"><path d="M12.78 5.22a.749.749 0 0 1 0 1.06l-4.25 4.25a.749.749 0 0 1-1.06 0L3.22 6.28a.749.749 0 1 1 1.06-1.06L8 8.939l3.72-3.719a.749.749 0 0 1 1.06 0Z"></path></svg></div></span></div><div data-line-number="49" class="child-of-line-20 child-of-line-47  react-line-number react-code-text" style="padding-right:16px">49</div><div data-line-number="50" class="child-of-line-20 child-of-line-47  react-line-number react-code-text" style="padding-right:16px">50</div><div data-line-number="51" class="child-of-line-20 child-of-line-47  react-line-number react-code-text" style="padding-right:16px">51</div><div data-line-number="52" class="child-of-line-20 child-of-line-47  react-line-number react-code-text" style="padding-right:16px">52</div><div data-line-number="53" class="child-of-line-20 child-of-line-47  react-line-number react-code-text" style="padding-right:16px">53</div><div data-line-number="54" class="child-of-line-20 child-of-line-47  react-line-number react-code-text" style="padding-right:16px">54</div><div data-line-number="55" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">55</div><div data-line-number="56" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">56</div><div data-line-number="57" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">57</div><div data-line-number="58" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">58</div><div data-line-number="59" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">59</div><div data-line-number="60" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">60</div><div data-line-number="61" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">61</div><div data-line-number="62" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">62</div><div data-line-number="63" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">63</div><div data-line-number="64" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">64</div><div data-line-number="65" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">65</div><div data-line-number="66" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">66</div><div data-line-number="67" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">67</div><div data-line-number="68" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">68</div><div data-line-number="69" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">69</div><div data-line-number="70" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">70</div><div data-line-number="71" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">71</div><div data-line-number="72" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">72</div><div data-line-number="73" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">73</div><div data-line-number="74" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">74</div><div data-line-number="75" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">75</div><div data-line-number="76" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">76</div><div data-line-number="77" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">77</div><div data-line-number="78" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">78</div><div data-line-number="79" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">79</div><div data-line-number="80" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">80</div><div data-line-number="81" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">81</div><div data-line-number="82" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">82</div><div data-line-number="83" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">83</div><div data-line-number="84" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">84</div><div data-line-number="85" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">85</div><div data-line-number="86" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">86</div><div data-line-number="87" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">87</div><div data-line-number="88" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">88</div><div data-line-number="89" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">89</div><div data-line-number="90" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">90</div><div data-line-number="91" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">91</div><div data-line-number="92" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">92<span class="Box-sc-g0xbh4-0 cJGaMs"><div aria-label="Collapse code section" role="button" class="Box-sc-g0xbh4-0 iGLarr"><svg aria-hidden="true" focusable="false" class="Octicon-sc-9kayk9-0" viewBox="0 0 16 16" width="16" height="16" fill="currentColor" style="display:inline-block;user-select:none;vertical-align:text-bottom;overflow:visible"><path d="M12.78 5.22a.749.749 0 0 1 0 1.06l-4.25 4.25a.749.749 0 0 1-1.06 0L3.22 6.28a.749.749 0 1 1 1.06-1.06L8 8.939l3.72-3.719a.749.749 0 0 1 1.06 0Z"></path></svg></div></span></div><div data-line-number="93" class="child-of-line-20 child-of-line-91  react-line-number react-code-text" style="padding-right:16px">93</div><div data-line-number="94" class="child-of-line-20 child-of-line-91  react-line-number react-code-text" style="padding-right:16px">94</div><div data-line-number="95" class="child-of-line-20 child-of-line-91  react-line-number react-code-text" style="padding-right:16px">95</div><div data-line-number="96" class="child-of-line-20 child-of-line-91  react-line-number react-code-text" style="padding-right:16px">96</div><div data-line-number="97" class="child-of-line-20 child-of-line-91  react-line-number react-code-text" style="padding-right:16px">97</div><div data-line-number="98" class="child-of-line-20 child-of-line-91  react-line-number react-code-text" style="padding-right:16px">98</div><div data-line-number="99" class="child-of-line-20 child-of-line-91  react-line-number react-code-text" style="padding-right:16px">99</div><div data-line-number="100" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">100</div><div data-line-number="101" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">101</div><div data-line-number="102" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">102</div><div data-line-number="103" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">103</div><div data-line-number="104" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">104</div><div data-line-number="105" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">105</div><div data-line-number="106" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">106</div><div data-line-number="107" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">107</div><div data-line-number="108" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">108</div><div data-line-number="109" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">109</div><div data-line-number="110" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">110</div><div data-line-number="111" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">111</div><div data-line-number="112" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">112</div><div data-line-number="113" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">113</div><div data-line-number="114" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">114</div><div data-line-number="115" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">115</div><div data-line-number="116" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">116</div><div data-line-number="117" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">117</div><div data-line-number="118" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">118</div><div data-line-number="119" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">119</div><div data-line-number="120" class="child-of-line-20  react-line-number react-code-text" style="padding-right:16px">120</div><div data-line-number="121" class="react-line-number react-code-text" style="padding-right:16px">121</div><div data-line-number="122" class="react-line-number react-code-text" style="padding-right:16px">122</div><div data-line-number="123" class="react-line-number react-code-text" style="padding-right:16px">123</div></div><div class="react-code-lines"><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC1" class="react-file-line html-div" data-testid="code-cell" data-line-number="1" style="position:relative"><span class="pl-c">/**</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC2" class="react-file-line html-div" data-testid="code-cell" data-line-number="2" style="position:relative"><span class="pl-c"> * GameEnv is a static class that manages the game environment.</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC3" class="react-file-line html-div" data-testid="code-cell" data-line-number="3" style="position:relative"><span class="pl-c"> * </span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC4" class="react-file-line html-div" data-testid="code-cell" data-line-number="4" style="position:relative"><span class="pl-c"> * The focus of the file is the canvas management and the calculation of the game area dimensions. </span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC5" class="react-file-line html-div" data-testid="code-cell" data-line-number="5" style="position:relative"><span class="pl-c"> * All calculations are based on the window size, header, and footer.</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC6" class="react-file-line html-div" data-testid="code-cell" data-line-number="6" style="position:relative"><span class="pl-c"> * </span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC7" class="react-file-line html-div" data-testid="code-cell" data-line-number="7" style="position:relative"><span class="pl-c"> * This code uses a classic Java static class pattern, which is nice for managing centralized data.</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC8" class="react-file-line html-div" data-testid="code-cell" data-line-number="8" style="position:relative"><span class="pl-c"> * </span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC9" class="react-file-line html-div" data-testid="code-cell" data-line-number="9" style="position:relative"><span class="pl-c"> * The static class pattern ensures that there is only one instance of the game environment,</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC10" class="react-file-line html-div" data-testid="code-cell" data-line-number="10" style="position:relative"><span class="pl-c"> * providing a single point of reference for all game objects. This approach helps maintain</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC11" class="react-file-line html-div" data-testid="code-cell" data-line-number="11" style="position:relative"><span class="pl-c"> * consistency and simplifies the management of shared resources like the canvas and its dimensions.</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC12" class="react-file-line html-div" data-testid="code-cell" data-line-number="12" style="position:relative"><span class="pl-c"> * </span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC13" class="react-file-line html-div" data-testid="code-cell" data-line-number="13" style="position:relative"><span class="pl-c"> * @class GameEnv</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC14" class="react-file-line html-div" data-testid="code-cell" data-line-number="14" style="position:relative"><span class="pl-c"> * @property {Object} canvas - The canvas element.</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC15" class="react-file-line html-div" data-testid="code-cell" data-line-number="15" style="position:relative"><span class="pl-c"> * @property {Object} ctx - The 2D rendering context of the canvas.</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC16" class="react-file-line html-div" data-testid="code-cell" data-line-number="16" style="position:relative"><span class="pl-c"> * @property {number} innerWidth - The inner width of the game area.</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC17" class="react-file-line html-div" data-testid="code-cell" data-line-number="17" style="position:relative"><span class="pl-c"> * @property {number} innerHeight - The inner height of the game area.</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC18" class="react-file-line html-div" data-testid="code-cell" data-line-number="18" style="position:relative"><span class="pl-c"> * @property {number} top - The top offset of the game area.</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC19" class="react-file-line html-div" data-testid="code-cell" data-line-number="19" style="position:relative"><span class="pl-c"> * @property {number} bottom - The bottom offset of the game area.</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC20" class="react-file-line html-div" data-testid="code-cell" data-line-number="20" style="position:relative"><span class="pl-c"> */</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC21" class="react-file-line html-div" data-testid="code-cell" data-line-number="21" style="position:relative"><span class="pl-k">class</span> <span class="pl-v">GameEnv</span> <span class="pl-kos">{</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC22" class="react-file-line html-div" data-testid="code-cell" data-line-number="22" style="position:relative">    <span class="pl-k">static</span> <span class="pl-c1">canvas</span><span class="pl-kos">;</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC23" class="react-file-line html-div" data-testid="code-cell" data-line-number="23" style="position:relative">    <span class="pl-k">static</span> <span class="pl-c1">ctx</span><span class="pl-kos">;</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC24" class="react-file-line html-div" data-testid="code-cell" data-line-number="24" style="position:relative">    <span class="pl-k">static</span> <span class="pl-c1">innerWidth</span><span class="pl-kos">;</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC25" class="react-file-line html-div" data-testid="code-cell" data-line-number="25" style="position:relative">    <span class="pl-k">static</span> <span class="pl-c1">innerHeight</span><span class="pl-kos">;</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC26" class="react-file-line html-div" data-testid="code-cell" data-line-number="26" style="position:relative">    <span class="pl-k">static</span> <span class="pl-c1">top</span><span class="pl-kos">;</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC27" class="react-file-line html-div" data-testid="code-cell" data-line-number="27" style="position:relative">    <span class="pl-k">static</span> <span class="pl-c1">bottom</span><span class="pl-kos">;</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC28" class="react-file-line html-div" data-testid="code-cell" data-line-number="28" style="position:relative">
</div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC29" class="react-file-line html-div" data-testid="code-cell" data-line-number="29" style="position:relative">    <span class="pl-c">/**</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC30" class="react-file-line html-div" data-testid="code-cell" data-line-number="30" style="position:relative"><span class="pl-c">     * Private constructor to prevent instantiation.</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC31" class="react-file-line html-div" data-testid="code-cell" data-line-number="31" style="position:relative"><span class="pl-c">     * </span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC32" class="react-file-line html-div" data-testid="code-cell" data-line-number="32" style="position:relative"><span class="pl-c">     * @constructor</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC33" class="react-file-line html-div" data-testid="code-cell" data-line-number="33" style="position:relative"><span class="pl-c">     * @throws {Error} Throws an error if an attempt is made to instantiate the class.</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC34" class="react-file-line html-div" data-testid="code-cell" data-line-number="34" style="position:relative"><span class="pl-c">     */</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC35" class="react-file-line html-div" data-testid="code-cell" data-line-number="35" style="position:relative">    <span class="pl-en">constructor</span><span class="pl-kos">(</span><span class="pl-kos">)</span> <span class="pl-kos">{</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC36" class="react-file-line html-div" data-testid="code-cell" data-line-number="36" style="position:relative">        <span class="pl-k">throw</span> <span class="pl-k">new</span> <span class="pl-v">Error</span><span class="pl-kos">(</span><span class="pl-s">&#039;GameEnv is a static class and cannot be instantiated.&#039;</span><span class="pl-kos">)</span><span class="pl-kos">;</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC37" class="react-file-line html-div" data-testid="code-cell" data-line-number="37" style="position:relative">    <span class="pl-kos">}</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC38" class="react-file-line html-div" data-testid="code-cell" data-line-number="38" style="position:relative">
</div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC39" class="react-file-line html-div" data-testid="code-cell" data-line-number="39" style="position:relative">    <span class="pl-c">/**</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC40" class="react-file-line html-div" data-testid="code-cell" data-line-number="40" style="position:relative"><span class="pl-c">     * Create the game environment by setting up the canvas and calculating dimensions.</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC41" class="react-file-line html-div" data-testid="code-cell" data-line-number="41" style="position:relative"><span class="pl-c">     * </span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC42" class="react-file-line html-div" data-testid="code-cell" data-line-number="42" style="position:relative"><span class="pl-c">     * This method sets the canvas element, calculates the top and bottom offsets,</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC43" class="react-file-line html-div" data-testid="code-cell" data-line-number="43" style="position:relative"><span class="pl-c">     * and determines the inner width and height of the game area. It then sizes the canvas</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC44" class="react-file-line html-div" data-testid="code-cell" data-line-number="44" style="position:relative"><span class="pl-c">     * to fit within the calculated dimensions.</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC45" class="react-file-line html-div" data-testid="code-cell" data-line-number="45" style="position:relative"><span class="pl-c">     * </span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC46" class="react-file-line html-div" data-testid="code-cell" data-line-number="46" style="position:relative"><span class="pl-c">     * @static</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC47" class="react-file-line html-div" data-testid="code-cell" data-line-number="47" style="position:relative"><span class="pl-c">     */</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC48" class="react-file-line html-div" data-testid="code-cell" data-line-number="48" style="position:relative">    <span class="pl-k">static</span> <span class="pl-en">create</span><span class="pl-kos">(</span><span class="pl-kos">)</span> <span class="pl-kos">{</span></div></div></div><div class="child-of-line-20 child-of-line-47  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC49" class="react-file-line html-div" data-testid="code-cell" data-line-number="49" style="position:relative">        <span class="pl-smi">this</span><span class="pl-kos">.</span><span class="pl-en">setCanvas</span><span class="pl-kos">(</span><span class="pl-kos">)</span><span class="pl-kos">;</span></div></div></div><div class="child-of-line-20 child-of-line-47  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC50" class="react-file-line html-div" data-testid="code-cell" data-line-number="50" style="position:relative">        <span class="pl-smi">this</span><span class="pl-kos">.</span><span class="pl-en">setTop</span><span class="pl-kos">(</span><span class="pl-kos">)</span><span class="pl-kos">;</span></div></div></div><div class="child-of-line-20 child-of-line-47  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC51" class="react-file-line html-div" data-testid="code-cell" data-line-number="51" style="position:relative">        <span class="pl-smi">this</span><span class="pl-kos">.</span><span class="pl-en">setBottom</span><span class="pl-kos">(</span><span class="pl-kos">)</span><span class="pl-kos">;</span></div></div></div><div class="child-of-line-20 child-of-line-47  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC52" class="react-file-line html-div" data-testid="code-cell" data-line-number="52" style="position:relative">        <span class="pl-smi">this</span><span class="pl-kos">.</span><span class="pl-c1">innerWidth</span> <span class="pl-c1">=</span> <span class="pl-smi">window</span><span class="pl-kos">.</span><span class="pl-c1">innerWidth</span><span class="pl-kos">;</span></div></div></div><div class="child-of-line-20 child-of-line-47  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC53" class="react-file-line html-div" data-testid="code-cell" data-line-number="53" style="position:relative">        <span class="pl-smi">this</span><span class="pl-kos">.</span><span class="pl-c1">innerHeight</span> <span class="pl-c1">=</span> <span class="pl-smi">window</span><span class="pl-kos">.</span><span class="pl-c1">innerHeight</span> <span class="pl-c1">-</span> <span class="pl-smi">this</span><span class="pl-kos">.</span><span class="pl-c1">top</span> <span class="pl-c1">-</span> <span class="pl-smi">this</span><span class="pl-kos">.</span><span class="pl-c1">bottom</span><span class="pl-kos">;</span></div></div></div><div class="child-of-line-20 child-of-line-47  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC54" class="react-file-line html-div" data-testid="code-cell" data-line-number="54" style="position:relative">        <span class="pl-smi">this</span><span class="pl-kos">.</span><span class="pl-en">size</span><span class="pl-kos">(</span><span class="pl-kos">)</span><span class="pl-kos">;</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC55" class="react-file-line html-div" data-testid="code-cell" data-line-number="55" style="position:relative">    <span class="pl-kos">}</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC56" class="react-file-line html-div" data-testid="code-cell" data-line-number="56" style="position:relative">
</div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC57" class="react-file-line html-div" data-testid="code-cell" data-line-number="57" style="position:relative">    <span class="pl-c">/**</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC58" class="react-file-line html-div" data-testid="code-cell" data-line-number="58" style="position:relative"><span class="pl-c">     * Sets the canvas element and its 2D rendering context.</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC59" class="react-file-line html-div" data-testid="code-cell" data-line-number="59" style="position:relative"><span class="pl-c">     * </span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC60" class="react-file-line html-div" data-testid="code-cell" data-line-number="60" style="position:relative"><span class="pl-c">     * @static</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC61" class="react-file-line html-div" data-testid="code-cell" data-line-number="61" style="position:relative"><span class="pl-c">     */</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC62" class="react-file-line html-div" data-testid="code-cell" data-line-number="62" style="position:relative">    <span class="pl-k">static</span> <span class="pl-en">setCanvas</span><span class="pl-kos">(</span><span class="pl-kos">)</span> <span class="pl-kos">{</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC63" class="react-file-line html-div" data-testid="code-cell" data-line-number="63" style="position:relative">        <span class="pl-smi">this</span><span class="pl-kos">.</span><span class="pl-c1">canvas</span> <span class="pl-c1">=</span> <span class="pl-smi">document</span><span class="pl-kos">.</span><span class="pl-en">getElementById</span><span class="pl-kos">(</span><span class="pl-s">&#039;gameCanvas&#039;</span><span class="pl-kos">)</span><span class="pl-kos">;</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC64" class="react-file-line html-div" data-testid="code-cell" data-line-number="64" style="position:relative">        <span class="pl-smi">this</span><span class="pl-kos">.</span><span class="pl-c1">ctx</span> <span class="pl-c1">=</span> <span class="pl-smi">this</span><span class="pl-kos">.</span><span class="pl-c1">canvas</span><span class="pl-kos">.</span><span class="pl-en">getContext</span><span class="pl-kos">(</span><span class="pl-s">&#039;2d&#039;</span><span class="pl-kos">)</span><span class="pl-kos">;</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC65" class="react-file-line html-div" data-testid="code-cell" data-line-number="65" style="position:relative">    <span class="pl-kos">}</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC66" class="react-file-line html-div" data-testid="code-cell" data-line-number="66" style="position:relative">
</div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC67" class="react-file-line html-div" data-testid="code-cell" data-line-number="67" style="position:relative">    <span class="pl-c">/**</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC68" class="react-file-line html-div" data-testid="code-cell" data-line-number="68" style="position:relative"><span class="pl-c">     * Sets the top offset based on the height of the header element.</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC69" class="react-file-line html-div" data-testid="code-cell" data-line-number="69" style="position:relative"><span class="pl-c">     * </span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC70" class="react-file-line html-div" data-testid="code-cell" data-line-number="70" style="position:relative"><span class="pl-c">     * @static</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC71" class="react-file-line html-div" data-testid="code-cell" data-line-number="71" style="position:relative"><span class="pl-c">     */</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC72" class="react-file-line html-div" data-testid="code-cell" data-line-number="72" style="position:relative">    <span class="pl-k">static</span> <span class="pl-en">setTop</span><span class="pl-kos">(</span><span class="pl-kos">)</span> <span class="pl-kos">{</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC73" class="react-file-line html-div" data-testid="code-cell" data-line-number="73" style="position:relative">        <span class="pl-k">const</span> <span class="pl-s1">header</span> <span class="pl-c1">=</span> <span class="pl-smi">document</span><span class="pl-kos">.</span><span class="pl-en">querySelector</span><span class="pl-kos">(</span><span class="pl-s">&#039;header&#039;</span><span class="pl-kos">)</span><span class="pl-kos">;</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC74" class="react-file-line html-div" data-testid="code-cell" data-line-number="74" style="position:relative">        <span class="pl-smi">this</span><span class="pl-kos">.</span><span class="pl-c1">top</span> <span class="pl-c1">=</span> <span class="pl-s1">header</span> ? <span class="pl-s1">header</span><span class="pl-kos">.</span><span class="pl-c1">offsetHeight</span> : <span class="pl-c1">0</span><span class="pl-kos">;</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC75" class="react-file-line html-div" data-testid="code-cell" data-line-number="75" style="position:relative">    <span class="pl-kos">}</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC76" class="react-file-line html-div" data-testid="code-cell" data-line-number="76" style="position:relative">
</div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC77" class="react-file-line html-div" data-testid="code-cell" data-line-number="77" style="position:relative">    <span class="pl-c">/**</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC78" class="react-file-line html-div" data-testid="code-cell" data-line-number="78" style="position:relative"><span class="pl-c">     * Sets the bottom offset based on the height of the footer element.</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC79" class="react-file-line html-div" data-testid="code-cell" data-line-number="79" style="position:relative"><span class="pl-c">     * </span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC80" class="react-file-line html-div" data-testid="code-cell" data-line-number="80" style="position:relative"><span class="pl-c">     * @static</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC81" class="react-file-line html-div" data-testid="code-cell" data-line-number="81" style="position:relative"><span class="pl-c">     */</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC82" class="react-file-line html-div" data-testid="code-cell" data-line-number="82" style="position:relative">    <span class="pl-k">static</span> <span class="pl-en">setBottom</span><span class="pl-kos">(</span><span class="pl-kos">)</span> <span class="pl-kos">{</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC83" class="react-file-line html-div" data-testid="code-cell" data-line-number="83" style="position:relative">        <span class="pl-k">const</span> <span class="pl-s1">footer</span> <span class="pl-c1">=</span> <span class="pl-smi">document</span><span class="pl-kos">.</span><span class="pl-en">querySelector</span><span class="pl-kos">(</span><span class="pl-s">&#039;footer&#039;</span><span class="pl-kos">)</span><span class="pl-kos">;</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC84" class="react-file-line html-div" data-testid="code-cell" data-line-number="84" style="position:relative">        <span class="pl-smi">this</span><span class="pl-kos">.</span><span class="pl-c1">bottom</span> <span class="pl-c1">=</span> <span class="pl-s1">footer</span> ? <span class="pl-s1">footer</span><span class="pl-kos">.</span><span class="pl-c1">offsetHeight</span> : <span class="pl-c1">0</span><span class="pl-kos">;</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC85" class="react-file-line html-div" data-testid="code-cell" data-line-number="85" style="position:relative">    <span class="pl-kos">}</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC86" class="react-file-line html-div" data-testid="code-cell" data-line-number="86" style="position:relative">
</div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC87" class="react-file-line html-div" data-testid="code-cell" data-line-number="87" style="position:relative">    <span class="pl-c">/**</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC88" class="react-file-line html-div" data-testid="code-cell" data-line-number="88" style="position:relative"><span class="pl-c">     * Sizes the canvas to fit within the calculated dimensions.</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC89" class="react-file-line html-div" data-testid="code-cell" data-line-number="89" style="position:relative"><span class="pl-c">     * </span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC90" class="react-file-line html-div" data-testid="code-cell" data-line-number="90" style="position:relative"><span class="pl-c">     * @static</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC91" class="react-file-line html-div" data-testid="code-cell" data-line-number="91" style="position:relative"><span class="pl-c">     */</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC92" class="react-file-line html-div" data-testid="code-cell" data-line-number="92" style="position:relative">    <span class="pl-k">static</span> <span class="pl-en">size</span><span class="pl-kos">(</span><span class="pl-kos">)</span> <span class="pl-kos">{</span></div></div></div><div class="child-of-line-20 child-of-line-91  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC93" class="react-file-line html-div" data-testid="code-cell" data-line-number="93" style="position:relative">        <span class="pl-smi">this</span><span class="pl-kos">.</span><span class="pl-c1">canvas</span><span class="pl-kos">.</span><span class="pl-c1">width</span> <span class="pl-c1">=</span> <span class="pl-smi">this</span><span class="pl-kos">.</span><span class="pl-c1">innerWidth</span><span class="pl-kos">;</span></div></div></div><div class="child-of-line-20 child-of-line-91  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC94" class="react-file-line html-div" data-testid="code-cell" data-line-number="94" style="position:relative">        <span class="pl-smi">this</span><span class="pl-kos">.</span><span class="pl-c1">canvas</span><span class="pl-kos">.</span><span class="pl-c1">height</span> <span class="pl-c1">=</span> <span class="pl-smi">this</span><span class="pl-kos">.</span><span class="pl-c1">innerHeight</span><span class="pl-kos">;</span></div></div></div><div class="child-of-line-20 child-of-line-91  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC95" class="react-file-line html-div" data-testid="code-cell" data-line-number="95" style="position:relative">        <span class="pl-smi">this</span><span class="pl-kos">.</span><span class="pl-c1">canvas</span><span class="pl-kos">.</span><span class="pl-c1">style</span><span class="pl-kos">.</span><span class="pl-c1">width</span> <span class="pl-c1">=</span> <span class="pl-s">`<span class="pl-s1"><span class="pl-kos">${</span><span class="pl-smi">this</span><span class="pl-kos">.</span><span class="pl-c1">innerWidth</span><span class="pl-kos">}</span></span>px`</span><span class="pl-kos">;</span></div></div></div><div class="child-of-line-20 child-of-line-91  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC96" class="react-file-line html-div" data-testid="code-cell" data-line-number="96" style="position:relative">        <span class="pl-smi">this</span><span class="pl-kos">.</span><span class="pl-c1">canvas</span><span class="pl-kos">.</span><span class="pl-c1">style</span><span class="pl-kos">.</span><span class="pl-c1">height</span> <span class="pl-c1">=</span> <span class="pl-s">`<span class="pl-s1"><span class="pl-kos">${</span><span class="pl-smi">this</span><span class="pl-kos">.</span><span class="pl-c1">innerHeight</span><span class="pl-kos">}</span></span>px`</span><span class="pl-kos">;</span></div></div></div><div class="child-of-line-20 child-of-line-91  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC97" class="react-file-line html-div" data-testid="code-cell" data-line-number="97" style="position:relative">        <span class="pl-smi">this</span><span class="pl-kos">.</span><span class="pl-c1">canvas</span><span class="pl-kos">.</span><span class="pl-c1">style</span><span class="pl-kos">.</span><span class="pl-c1">position</span> <span class="pl-c1">=</span> <span class="pl-s">&#039;absolute&#039;</span><span class="pl-kos">;</span></div></div></div><div class="child-of-line-20 child-of-line-91  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC98" class="react-file-line html-div" data-testid="code-cell" data-line-number="98" style="position:relative">        <span class="pl-smi">this</span><span class="pl-kos">.</span><span class="pl-c1">canvas</span><span class="pl-kos">.</span><span class="pl-c1">style</span><span class="pl-kos">.</span><span class="pl-c1">left</span> <span class="pl-c1">=</span> <span class="pl-s">&#039;0px&#039;</span><span class="pl-kos">;</span></div></div></div><div class="child-of-line-20 child-of-line-91  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC99" class="react-file-line html-div" data-testid="code-cell" data-line-number="99" style="position:relative">        <span class="pl-smi">this</span><span class="pl-kos">.</span><span class="pl-c1">canvas</span><span class="pl-kos">.</span><span class="pl-c1">style</span><span class="pl-kos">.</span><span class="pl-c1">top</span> <span class="pl-c1">=</span> <span class="pl-s">`<span class="pl-s1"><span class="pl-kos">${</span><span class="pl-smi">this</span><span class="pl-kos">.</span><span class="pl-c1">top</span><span class="pl-kos">}</span></span>px`</span><span class="pl-kos">;</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC100" class="react-file-line html-div" data-testid="code-cell" data-line-number="100" style="position:relative">    <span class="pl-kos">}</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC101" class="react-file-line html-div" data-testid="code-cell" data-line-number="101" style="position:relative">
</div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC102" class="react-file-line html-div" data-testid="code-cell" data-line-number="102" style="position:relative">    <span class="pl-c">/**</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC103" class="react-file-line html-div" data-testid="code-cell" data-line-number="103" style="position:relative"><span class="pl-c">     * Resizes the game environment by re-creating it.</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC104" class="react-file-line html-div" data-testid="code-cell" data-line-number="104" style="position:relative"><span class="pl-c">     * </span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC105" class="react-file-line html-div" data-testid="code-cell" data-line-number="105" style="position:relative"><span class="pl-c">     * @static</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC106" class="react-file-line html-div" data-testid="code-cell" data-line-number="106" style="position:relative"><span class="pl-c">     */</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC107" class="react-file-line html-div" data-testid="code-cell" data-line-number="107" style="position:relative">    <span class="pl-k">static</span> <span class="pl-en">resize</span><span class="pl-kos">(</span><span class="pl-kos">)</span> <span class="pl-kos">{</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC108" class="react-file-line html-div" data-testid="code-cell" data-line-number="108" style="position:relative">        <span class="pl-smi">this</span><span class="pl-kos">.</span><span class="pl-en">create</span><span class="pl-kos">(</span><span class="pl-kos">)</span><span class="pl-kos">;</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC109" class="react-file-line html-div" data-testid="code-cell" data-line-number="109" style="position:relative">    <span class="pl-kos">}</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC110" class="react-file-line html-div" data-testid="code-cell" data-line-number="110" style="position:relative">
</div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC111" class="react-file-line html-div" data-testid="code-cell" data-line-number="111" style="position:relative">    <span class="pl-c">/**</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC112" class="react-file-line html-div" data-testid="code-cell" data-line-number="112" style="position:relative"><span class="pl-c">     * Clears the canvas.</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC113" class="react-file-line html-div" data-testid="code-cell" data-line-number="113" style="position:relative"><span class="pl-c">     * </span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC114" class="react-file-line html-div" data-testid="code-cell" data-line-number="114" style="position:relative"><span class="pl-c">     * This method clears the entire canvas, making it ready for the next frame.</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC115" class="react-file-line html-div" data-testid="code-cell" data-line-number="115" style="position:relative"><span class="pl-c">     * </span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC116" class="react-file-line html-div" data-testid="code-cell" data-line-number="116" style="position:relative"><span class="pl-c">     * @static</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC117" class="react-file-line html-div" data-testid="code-cell" data-line-number="117" style="position:relative"><span class="pl-c">     */</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC118" class="react-file-line html-div" data-testid="code-cell" data-line-number="118" style="position:relative">    <span class="pl-k">static</span> <span class="pl-en">clear</span><span class="pl-kos">(</span><span class="pl-kos">)</span> <span class="pl-kos">{</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC119" class="react-file-line html-div" data-testid="code-cell" data-line-number="119" style="position:relative">        <span class="pl-smi">this</span><span class="pl-kos">.</span><span class="pl-c1">ctx</span><span class="pl-kos">.</span><span class="pl-en">clearRect</span><span class="pl-kos">(</span><span class="pl-c1">0</span><span class="pl-kos">,</span> <span class="pl-c1">0</span><span class="pl-kos">,</span> <span class="pl-smi">this</span><span class="pl-kos">.</span><span class="pl-c1">innerWidth</span><span class="pl-kos">,</span> <span class="pl-smi">this</span><span class="pl-kos">.</span><span class="pl-c1">innerHeight</span><span class="pl-kos">)</span><span class="pl-kos">;</span></div></div></div><div class="child-of-line-20  react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC120" class="react-file-line html-div" data-testid="code-cell" data-line-number="120" style="position:relative">    <span class="pl-kos">}</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC121" class="react-file-line html-div" data-testid="code-cell" data-line-number="121" style="position:relative"><span class="pl-kos">}</span></div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC122" class="react-file-line html-div" data-testid="code-cell" data-line-number="122" style="position:relative">
</div></div></div><div class="react-code-text react-code-line-contents" style="min-height:auto"><div><div id="LC123" class="react-file-line html-div" data-testid="code-cell" data-line-number="123" style="position:relative"><span class="pl-k">export</span> <span class="pl-k">default</span> <span class="pl-v">GameEnv</span><span class="pl-kos">;</span></div></div></div></div></div></div><div id="copilot-button-container"></div></div><div id="highlighted-line-menu-container"></div></div></div><button hidden="" data-testid="hotkey-button" data-hotkey-scope="read-only-cursor-text-area"></button><button hidden=""></button></section></div></div></div> <!-- --> <!-- --> </div></div></div><div class="Box-sc-g0xbh4-0"></div></div></div></div></div><div id="find-result-marks-container" class="Box-sc-g0xbh4-0 cCoXib"></div><button hidden="" data-testid="" data-hotkey-scope="read-only-cursor-text-area"></button><button hidden=""></button></div> <!-- --> <!-- --> <script type="application/json" id="__PRIMER_DATA_:R0:__">{"resolvedServerColorMode":"day"}</script></div>
</react-app>
</turbo-frame>
